...
/// Message :Super Admin Can View The Student Report From All Centres.
/// </summary>

namespace MVC1
{
    public class StudentReport_ctech
    {
        private string _qry;
        private int _retInt;
        ...
        public void GetStudentReport(GridView grdStudentReport, Label lblNoOfRecords, DropDownList ddlLocation, TextBox txtFromDate, TextBox txtToDate, TextBox txtSearch, DropDownList ddlTestStatus, Label lblMsg, int writeStatus, ListBox ddlcourse)
        {
            ...
            _qry = "SELECT R.Software_Id,R.Certificate_Id,S.studentId,Replace(S.studentName,'~','''')as studentName,S.StudentRegNo,Replace(CE.centreLocation,'~','''')as centreName,";
