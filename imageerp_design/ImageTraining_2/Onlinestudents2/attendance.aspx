<%@ Page Language="C#" MasterPageFile="~/Onlinestudents2/Mainmasterpage.master" AutoEventWireup="true" CodeFile="attendance.aspx.cs" Inherits="Onlinestudents2_Attendance" Title="Attendance Details" %>
    ...
    <table class="common" width="600px">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Software">
                            <ItemTemplate>
                               ...
                               <asp:HiddenField  runat="server" ID="HiddenField4"   Value='<%# Eval("module_id") %>' />
                               <asp:HiddenField  runat="server" ID="HiddenField5" Value='<%# Eval("Software_id") %>'  />
                             <asp:HiddenField   runat="server" ID="HiddenField6" Value='<%# Eval("content_id") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <tr><td> 
            ...
            <table><tr><td >Content </td> <td>
                <asp:TextBox ID="txtconten" runat="server" ReadOnly="True"></asp:TextBox> </td></tr>
            <tr><td> Class Date</td> <td> 
                <asp:TextBox ID="txtclassdate" runat="server" ReadOnly="True"></asp:TextBox></td></tr>
                <tr>
                    <td>
                        Software
                    </td>
                    <td>
                        <asp:TextBox ID="txtsoft" runat="server" ReadOnly="True"></asp:TextBox></td>
                </tr>
            </table>
            <table>
        <tr>
