<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="superadmin_Login" EnableEventValidation="false" %>
...
<script language="javascript" type="text/javascript">
    ...
    function clearValidation(fieldList) {	
		...
		for(i=0;i<field.length;i++) {
			if(document.getElementById(field[i]).value!="") {
				document.getElementById(field[i]).style.border="#fff 1px solid";
			}
		}
    ...
    function loginval(){
		...
		if(trim(document.getElementById("txtusername").value)==""){
		   ...
		   document.getElementById("txtusername").style.border="#900900 1px solid";
		   return false;
		}    
		   ...
		   document.getElementById("txtpassword").style.border="#900900 1px solid";
		   return false;
       }   
       else{
       	   return true;
...
<form id="form1" runat="server">
  ...
  <div class="inner-cont3 login-outer-cont">
    ...
    <div id="footer" class="footer">&copy; 2010 Image Infotainment Limited. All rights reserved.</div>
  </div>
</form>
<script type="text/javascript">
