<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="Thankyou.aspx.cs" Inherits="Onlinestudents2_superadmin_Default" Title="Thankyou Page" %>
...
<!--Follow up  start-->
    <div>
        ...
        <table style="width:300;  margin:auto;"  border="1"   > 
            <tr>
                <td colspan="5" style="padding:0px; " ><h4 style="text-align:center;">Thank you for the Enquiry</h4>
                </td>
            </tr>
            <tr>
