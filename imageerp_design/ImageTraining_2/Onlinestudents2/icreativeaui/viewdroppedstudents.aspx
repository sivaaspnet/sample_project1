<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="viewdroppedstudents.aspx.cs" Inherits="viewdroppedstudents" Title="Students Report-Dropped" %>
  ...
  function CheckAll(chk)
{
  ...
  for (i=0; i<items.length; i++)
  {
   ...
   <div class="title-cont">
    <h3 class="cont-title">Students List-Dropped </h3>    
    <div class="clear"></div>
  </div>
