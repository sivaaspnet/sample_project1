<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="createnewBatchchart.aspx.cs" Inherits="superadmin_createnewBatchchart" Title="Create New Batch" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="Server" AsyncPostBackTimeOut="36000"></asp:ScriptManager>
             ...
             <tr id="dayslot" style="display:none;">
                 <td style="">
                     <span class="file">&nbsp;<asp:Label ID="Label11" 
                         runat="server" Text="Batch Time"></asp:Label></span></td>
                 <td style="">
 ...
 <asp:UpdatePanel ID="uptpanelbutton" runat="server"   >   
  <Triggers >
...
<tr>
<th rowspan="4">Faculty Name</th>
<th colspan="4">7AM TO 9AM</th>
<th colspan="4">9AM TO 11AM</th>
<th colspan="4">11AM TO 1PM</th>
<th colspan="4">1PM TO 3PM</th>
<th colspan="4">3PM TO 5PM</th>
<th colspan="4">5PM TO 7PM</th>
<th colspan="4">7PM TO 9PM</th>
</tr>
<th>M</th>
<th>T</th>
<th>D</th>
