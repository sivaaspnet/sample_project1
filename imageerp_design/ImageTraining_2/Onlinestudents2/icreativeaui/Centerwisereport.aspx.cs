...
public partial class superadmin_Centerwisereport : System.Web.UI.Page
{
    ...
    private void filltype()
    {
        ...
        try
        {
            ...
            cmd.Parameters.Add("@ctech", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@ctechdiploma", SqlDbType.VarChar, 50);
            ...
            cmd.Parameters["@ctech"].Direction = ParameterDirection.Output;
            cmd.Parameters["@ctechdiploma"].Direction = ParameterDirection.Output;
            ...
            cmd.Parameters.Add("@Printadvertisement", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Tvadvertisement", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@others", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Google", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@JustDial", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Sulekha", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@ROPS", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@ROCS", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@ROS", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Referenceofenquiry", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@WOM", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Board", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Billedvalue", SqlDbType.VarChar, 50);


            cmd.Parameters["@website"].Direction = ParameterDirection.Output;
            cmd.Parameters["@newspaper"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Printadvertisement"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Tvadvertisement"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Others"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Google"].Direction = ParameterDirection.Output;
            cmd.Parameters["@JustDial"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Sulekha"].Direction = ParameterDirection.Output;
            cmd.Parameters["@ROPS"].Direction = ParameterDirection.Output;
            cmd.Parameters["@ROCS"].Direction = ParameterDirection.Output;
            cmd.Parameters["@ROS"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Referenceofenquiry"].Direction = ParameterDirection.Output;
            cmd.Parameters["@WOM"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Board"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Billedvalue"].Direction = ParameterDirection.Output;




            cmd.Parameters.Add("@school", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@college", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Employed", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Unemployed", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@SelfEmployed", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Housewife", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@SrCitizen", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@MultimediaProfessional", SqlDbType.VarChar, 50);
            cmd.Parameters.Add("@Corporate", SqlDbType.VarChar, 50);

            cmd.Parameters["@school"].Direction = ParameterDirection.Output;
            cmd.Parameters["@college"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Employed"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Unemployed"].Direction = ParameterDirection.Output;
            cmd.Parameters["@SelfEmployed"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Housewife"].Direction = ParameterDirection.Output;
            cmd.Parameters["@SrCitizen"].Direction = ParameterDirection.Output;
            cmd.Parameters["@MultimediaProfessional"].Direction = ParameterDirection.Output;
            cmd.Parameters["@Corporate"].Direction = ParameterDirection.Output;
...
from erp_invoicedetails inv inner join img_coursedetails cou on inv.courseid=cou.course_id and inv.status='active' and studentstatus='active' and inv.centercode='" + Session["SA_centre_code"].ToString() + "' inner join adm_personalparticulars p on p.student_id=inv.studentid and p.centre_code=inv.centercode and substring(p.enq_number,1,3)<>'old' inner join adm_generalinfo b on inv.studentid=b.student_id ";
            ...
            //lblctech.Text = (string)cmd.Parameters["@ctech"].Value;
            //lblctechdiploma.Text = (string)cmd.Parameters["@ctechdiploma"].Value;

            total.Text = cnt.ToString();
            News.Text = (string)cmd.Parameters["@newspaper"].Value;
            Website.Text = (string)cmd.Parameters["@website"].Value;
            Advertisement.Text = (string)cmd.Parameters["@Printadvertisement"].Value;
            tv.Text = (string)cmd.Parameters["@Tvadvertisement"].Value;
            others.Text = (string)cmd.Parameters["@Others"].Value;
            google.Text = (string)cmd.Parameters["@Google"].Value;
            JustDial.Text = (string)cmd.Parameters["@JustDial"].Value;
            Sulekha.Text = (string)cmd.Parameters["@Sulekha"].Value;
            ROPS.Text = (string)cmd.Parameters["@ROPS"].Value;
            ROCS.Text = (string)cmd.Parameters["@ROCS"].Value;
            ROS.Text = (string)cmd.Parameters["@ROS"].Value;
            Referenceofenquiry.Text = (string)cmd.Parameters["@Referenceofenquiry"].Value;
            WOM.Text = (string)cmd.Parameters["@WOM"].Value;
            Board.Text = (string)cmd.Parameters["@Board"].Value;
            string a = (string)cmd.Parameters["@Billedvalue"].Value;
            double b = Convert.ToDouble(a);
            billedvalue.Text = amts(b);

            school.Text = (string)cmd.Parameters["@school"].Value;
            college.Text = (string)cmd.Parameters["@college"].Value;
            Employed.Text = (string)cmd.Parameters["@Employed"].Value;
            Unemployed.Text = (string)cmd.Parameters["@Unemployed"].Value;
            Self.Text = (string)cmd.Parameters["@SelfEmployed"].Value;
            Housewife.Text = (string)cmd.Parameters["@Housewife"].Value;
            Citizen.Text = (string)cmd.Parameters["@SrCitizen"].Value;
            Professional.Text = (string)cmd.Parameters["@MultimediaProfessional"].Value;
            Corporate.Text = (string)cmd.Parameters["@Corporate"].Value;
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        Response.Clear();
        Response.AddHeader("content-disposition", "attachment;filename=CentrewiseReport.xls");
