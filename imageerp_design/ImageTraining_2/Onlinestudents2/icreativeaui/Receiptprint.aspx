<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receiptprint.aspx.cs" Inherits="superadmin_Receiptprint" %>
...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr style="border:none;" align="center">
    <td >
        ...
        <tr id="trreason"  runat="server" visible="false"><td>
        Reason For Change Receipt : 
            <asp:Label ID="lblreason" runat="server" Text=""></asp:Label>
        </td></tr>
        <tr><td align="center">
        
        <asp:HiddenField ID="lblstudid" runat="server" />
        <asp:HiddenField ID="lbl_recpno" runat="server" /> <input id="Button1" class="btnStyle1" onclick="window.open('Receiptprintpage.aspx?studid=<%=lblstudid.Value%>&recptno=<%=lbl_recpno.Value%>&invoiceno=<%=lbl_inv.Value%>','PrintMe','height=500px,width=600px,scrollbars=1')"
                        type="button" value="Print" />
        <asp:HiddenField ID="lbl_inv" runat="server" />
                    <asp:Button ID="Button2" CssClass="btnStyle1" runat="server" OnClick="Button2_Click" OnClientClick="javascript:return breakout_of_frame();"
                        Text="View Receipt Details" /></td></tr>
