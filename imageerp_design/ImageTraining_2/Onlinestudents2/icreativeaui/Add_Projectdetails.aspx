<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="Add_Projectdetails.aspx.cs" Inherits="superadmin_Add_Moduledetails" Title="Add_Moduledetails" %>
...
<h4>
    ...
    <table cellpadding="0" cellspacing="0" class="common" width="100%">
        <tr>
    <td >               
       <asp:Label ID="Label1" runat="server" Text="Searchby Project Name"></asp:Label>
        <br />     
        <asp:DropDownList ID="ddl_project" runat="server" Width="185px">
        </asp:DropDownList>
    ...
    <asp:GridView CssClass="common" ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="No Records Found" OnRowCommand="GridView1_RowCommand" OnPageIndexChanging="GridView1_PageIndexChanging" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action">
                         <ItemTemplate>
                             <asp:LinkButton ID="lnkedit" runat="server" CommandName="edt" CommandArgument='<%#Eval("projectId")%>'><img src="layout/edit.png" alt="edit" /></asp:LinkButton> |
                             <asp:LinkButton ID="lnkdelete" runat="server" CommandName="del" CommandArgument='<%#Eval("projectId")%>' OnClientClick="javascript:return confirm('Do you want to delete?');"><img src="layout/delete.png" alt="delete" /></asp:LinkButton>
                         </ItemTemplate>
        ...
        <EmptyDataRowStyle Font-Bold="True" ForeColor="Red" HorizontalAlign="Center" VerticalAlign="Middle" />
            ...
            <center>
                <asp:LinkButton ID="Linkdownlod" runat="server" OnClick="Linkdownlod_Click">Download Excel</asp:LinkButton>
            </center>
        ...
        <tr>
            <td colspan="2" style="height: 7px; text-align:center">
              ...
              <td style="height: 36px">
                        <asp:TextBox ID="txt_Modulename" runat="server" MaxLength="100" CssClass="text" Wi></asp:TextBox>
