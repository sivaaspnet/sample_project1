<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="Dualinvoice.aspx.cs" Inherits="Onlinestudents2_Default2" Title="Multiple Invoice/Course Upgrade" %>
...
return true;
  ...
  <div class="title-cont">
    <h3 class="cont-title">Multiple Invoice/Course Upgrade</h3>
   <%-- <div class="breadcrumps">
      <ul>
        <li><a href="DashboardV2.aspx">Dashboard</a>/</li>
        <li><a href="Extendnewcourse.aspx" class="last">Multiple Invoice/Course Upgrade</a></li>
      </ul>
    </div>
    <div class="clear"></div>--%>
  </div>
          ...
          <ul class="no-borders">
            ...
            <li style="text-align:center;">
              <div align="center" style="padding-bottom:25px;">
                <asp:Button ID="Button2" runat="server" CssClass="btnStyle1" OnClick="Button2_Click" Text="submit" OnClientClick="return vvl();" />
                <asp:CustomValidator ID="custSpecialValidator" runat="server" ForeColor="Red" ErrorMessage="Please enter valid characters." OnServerValidate="Validate_Special" ControlToValidate="txt_studentid"></asp:CustomValidator>
              </div>
            </li>
          </ul>
          <div class="clear"></div>
        ...
        <div class="form-cont">
          <ul class="no-borders">
            ...
            <li id="lump3">
              ...
              <asp:CheckBox ID="CheckBox1" runat="server" Text="Include tax" OnClick="return taxcalc();" Width="84px" />
            </li>
            <li id="lump2">
              <div class="wth-1"><label class="label-txt3">No. of Installments :</label></div>
              <div class="wth-2">
              ...
              <asp:Button ID="Button3" runat="server" OnClientClick="return checkval();" Text="Calculation" CssClass="btnStyle1" />
              <br />
              Maximum  number of installments :
              <asp:Label ID="lblmaxinstallnumber" runat="server" Text="0" CssClass="label-txt2"></asp:Label>
              </div>
            </li>
            <li>
            ...
            <li>
              <label class="label-txt">Coursestart date <span style="color: #ff0000">*</span></label>
            ...
            <li>
              <label class="label-txt">Installment Date <span style="color: #ff0000">*</span></label>
              <span class="date-pick-cont">
