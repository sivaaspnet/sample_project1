<%@ Page Language="C#" MasterPageFile="Ipadmasterpage.master" AutoEventWireup="true" CodeFile="quickpreInvoice.aspx.cs" Inherits="superadmin_preInvoicedetails" Title="PreInvoice Details" %>
...
//        var toDate = parseInt(curr_year +''+ mon +''+ curr_date);
        ...
        else if (trim(document.getElementById("ContentPlaceHolder1_txtinstalldate").value) == "") {
        ...
        else if (document.getElementById("ContentPlaceHolder1_hdnpay").value == "2" && (trim(document.getElementById("ContentPlaceHolder1_txtinstall").value) == "" || parseInt(document.getElementById("ContentPlaceHolder1_txtinstall").value) < 1)) {
        ...
        else if (document.getElementById("ContentPlaceHolder1_hdnpay").value == "2" && document.getElementById("ContentPlaceHolder1_txtinstall").value > 0 && document.getElementById("ContentPlaceHolder1_txtinstalldate").value == "") {
            alert("Please Enter your Installment date");
            document.getElementById("ContentPlaceHolder1_txtinstalldate").value = "";
            document.getElementById("ContentPlaceHolder1_txtinstalldate").focus();
            document.getElementById("ContentPlaceHolder1_txtinstalldate").style.border = "#ff0000 1px solid";
    ...
    <div class="form-cont">
      <ul>
        ...
        <li>
          ...
          <asp:TextBox ID="txtaddress" CssClass="text area-txt" runat="server" TextMode="MultiLine" Height="57px" ReadOnly="True" ></asp:TextBox>
          <div class="clear"></div>
        </li>
        <li>
          <label class="label-txt">Mobile</label>
          <asp:TextBox ID="txtphone" CssClass="text input-txt" MaxLength="11" onKeyPress="return CheckNumeric(event)" runat="server"></asp:TextBox>
          <span class="file">
        ...
        <li>
          ...
          <asp:DropDownList ID="txtcoursename" runat="server" AutoPostBack="True" OnSelectedIndexChanged="txtcoursename_SelectedIndexChanged" Visible="False" CssClass="sele-txt"> </asp:DropDownList>
          &nbsp;&nbsp;
          <asp:DropDownList ID="txtcourseid" CssClass="select sele-txt" runat="server" Visible="False"></asp:DropDownList>
          <asp:TextBox ID="txtCName" runat="server" CssClass="text input-txt f_left" ReadOnly="True"></asp:TextBox>
          <div class="clear"></div>
        </li>
        <li>
        ...
        <li>
          ...
          <span class="date-pick-cont"><asp:TextBox ID="txtdate" CssClass="text datepicker date-input-txt" runat="server" onpaste="return false" onKeyPress="return false" ></asp:TextBox></span>
          <div class="clear"></div>
        </li>
        <li>
        ...
        <li>
          <label class="label-txt">Registration Amount</label>
          <asp:Label ID="lbl_registration" runat="server" CssClass="form-txt"></asp:Label>
          <div class="clear"></div>
        </li>
        <li>
        ...
        <li>
          ...
          <asp:Label ID="lbltotlumpinitial_tax" runat="server" Text='' CssClass="form-txt"></asp:Label>
          <div class="clear"></div>
        </li>
        <li>
          <label class="label-txt">Next Installment Date</label>
          <span class="date-pick-cont"><asp:TextBox ID="txtinstalldate" CssClass="text datepicker date-input-txt" runat="server" onpaste="return false" onKeyPress="return false" ></asp:TextBox></span>
          <div class="clear"></div>
        </li>
        <li>
    ...
    <div class="form-cont">
      <ul>
        ...
        <li>
          ...
          <asp:Label ID="txtpaytowards" runat="server" Text='Image infotainment limited' CssClass="form-txt"></asp:Label>
          <div class="clear"></div>
        </li>
        <li style="text-align:center;">
          <div style="padding-bottom:25px;" align="center"><asp:Button ID="Button1" runat="server" CssClass="btnStyle1" Text="Update" OnClick="Button1_Click" OnClientClick="javascript:return summaryvalidate();" />
        <asp:Button ID="Button2" runat="server" CssClass="btnStyle1" Text="Confirm" OnClick="Button2_Click" /></div>
        </li>
      </ul>
      <div class="clear"></div>
    </div>
