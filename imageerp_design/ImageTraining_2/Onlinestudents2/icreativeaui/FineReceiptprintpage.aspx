<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FineReceiptprintpage.aspx.cs" Inherits="superadmin_FineReceiptprintpage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Fine Receipt Print </title>
...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr style="border:none;" align="center">
    <td >
        ...
        <asp:HiddenField ID="lbl_recpno" runat="server" /> 
</table>
