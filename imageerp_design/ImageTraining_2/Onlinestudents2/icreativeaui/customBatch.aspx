<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="customBatch.aspx.cs" Inherits="superadmin_createnewBatch" Title="Custom Batch" %>
...
//}
 ...
 var start = document.getElementById("ContentPlaceHolder1_txt_stratdate").value;
   ...
   else if(atLeasta>countdepta)
    {
        ...
        return false;
   }else if(document.getElementById("ContentPlaceHolder1_HiddenField2").value=="2,4,6" || document.getElementById("ContentPlaceHolder1_HiddenField2").value=="3,5,7" || document.getElementById("ContentPlaceHolder1_HiddenField2").value=="2,3,4,5,6,7" || document.getElementById("ContentPlaceHolder1_HiddenField2").value=="6,7" || document.getElementById("ContentPlaceHolder1_HiddenField2").value=="7" || document.getElementById("ContentPlaceHolder1_HiddenField2").value=="6")
    {
        alert("SlotDay Can't be MWF,TTS,Daily,WEEKEND");
        return false;
   }  
 ...
 <div class="free-forms">
         <table class="common" id="getdetails"  runat="server" width="100%">
             ...
             </asp:DropDownList><span class="file">
