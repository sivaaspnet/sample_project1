...
public partial class superadmin_1createnewBatch : System.Web.UI.Page
{
         ...
         else
         {
             ...
             if(Convert.ToInt32(hdnfreesystem.Value)>0)
             {
                 ...
                 foreach (GridViewRow gvrow in Gridvw.Rows)
                 {
                     ...
                     Label lbl_stdname = (Label)gvrow.Cells[0].FindControl("lbl_stdname");
                     ...
                     if (chkbox.Checked == true)
                     {
                         ...
                         //{
                         //    studentidlist = studentid.ToString() +"-"+ lbl_stdname.Text ;
                         //}
                         //else
                         //{
                         //    studentidlist = studentidlist + "<br>" + studentid.ToString() + "-" + lbl_stdname.Text;
                 ...
                 stulist.Text = studentidlist.ToString();
                 soft1();
