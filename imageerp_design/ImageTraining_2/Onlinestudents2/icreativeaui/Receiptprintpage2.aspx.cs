...
course_id=course_code where student_id='" + Request.QueryString["student_id"] + "' and center_code='" + manual + "' and rec_no='" + Request.QueryString["rec_no"] + "'";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lbl_recpno1.Text = dt.Rows[0]["rec_no"].ToString();
            lbl_date1.Text = dt.Rows[0]["date1"].ToString();
            lbl_coursecode1.Text = dt.Rows[0]["program"].ToString();
            lbl_studname1.Text = dt.Rows[0]["student_name"].ToString();
            lbl_sum1.Text = dt.Rows[0]["total"].ToString();
            lbl_inwords1.Text = dt.Rows[0]["payment_words"].ToString();
            lbl_monthinstallment1.Text = dt.Rows[0]["month_instal"].ToString();
            lbl_fees1.Text = dt.Rows[0]["amount"].ToString();
            lbl_tax1.Text = dt.Rows[0]["tax"].ToString();
            lbl_total1.Text = dt.Rows[0]["total"].ToString();
