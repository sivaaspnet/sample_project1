<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="Attendancebatchcode.aspx.cs" Inherits="superadmin_ViewbatchDetails" Title="View Batch Details" %>
                ...
                <Columns>
                 ...
                 <%--    <a href="" rel="htmltooltip" onclick="return false">
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                         <a  href="Attendance_details.aspx?batchcode=<%#Eval("BatchCode") %>" class="error"> Post </a>
