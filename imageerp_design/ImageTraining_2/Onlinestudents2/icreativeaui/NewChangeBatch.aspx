<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="NewChangeBatch.aspx.cs" ValidateRequest="false" Inherits="OnlineStudents_superadmin_ChangeBatch" Title="Change Batch" %>
    ...
    <table id="move" runat="server" cellpadding="0" cellspacing="0" class="common" width="100%">
         ...
         <tr class="no-borders">
             ...
             <td align="center" colspan="1" rowspan="10" style="text-align: center; width: 60%;">
                 <asp:GridView ID="GridView2" runat="server"  AutoGenerateColumns="False" Width="100%" OnPageIndexChanging="GridView2_PageIndexChanging" AllowPaging="True" PageSize="5">
                  <Columns>
                        <asp:TemplateField HeaderText="Content">
                                 <ItemTemplate>
                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("content") %>'></asp:Label>
                                 <asp:Label ID="subid" Visible="false" runat="server" Text='<%# Bind("subcontent_id") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
