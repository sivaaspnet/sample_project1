       ...
       //Response.Write(_Qry+"<br>");
         ...
         else
         {
             ...
             if(Convert.ToInt32(hdnfreesystem.Value)>0)
             {
                 ...
                 batchqry += " INSERT INTO [erp_batchdetails] ([software_id],[batchCode],[moduleId],[NoOfClass],[centreCode],[slot],[batchTiming],[status],[dateins],[slotday]) VALUES ('" + os + "','" + batch_code + "','" + ddl_coursename.SelectedValue + "','" + noofclass + "','" + Session["SA_centre_code"].ToString() + "','Zip','" + ddlbatch.SelectedValue + "," +ddlbatch0.SelectedValue + "','pending',getdate(),'" + slotdate + "') ";
