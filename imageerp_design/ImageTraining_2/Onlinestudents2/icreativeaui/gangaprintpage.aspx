<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gangaprintpage.aspx.cs" Inherits="Onlinestudents2_superadmin_Receiptprintpage" %>
        ...
        <td colspan="2" align="center" valign="middle">
          ...
          <tr>
            ...
            <td width="600px"><table align="CENTER" style="width: 100%">
              <tr>
                <td class="style3 style5" align="center" valign="middle" style="height: 28px"><div align="" class="style5 style1"><span style="font-size: 16pt"><strong>&nbsp; &nbsp;<span style="font-size: 18pt">VNXTL
                        TECH SERVICES PVT LTD<?xml namespace="" ns="urn:schemas-microsoft-com:office:office"
                            prefix="o" ?><o:p></o:p></span></strong></span></div></td>
              </tr>
              <tr>
                <td class="style3" align="center" valign="middle" style="height: 17px">
                    <p align="center" class="MsoNormal" style="margin: 0in 0in 0pt; text-align: center">
                        <span style="font-size: 9pt; font-family: 'Arial','sans-serif'">LAV Arcade,
                            <?xml namespace="" ns="urn:schemas-microsoft-com:office:smarttags" prefix="st1" ?><st1:street w:st="on"><st1:address 
                              w:st="on">#79, Bellary 
                              Road</st1:address></st1:street>, Ganga Nagar,
                            <st1:city w:st="on"><st1:place 
                              w:st="on">Bangalore</st1:place></st1:city>
                            560 032. Ph: 4128 4111<o:p></o:p></span></p>
                </td>
              </tr>
              <tr>
              ...
              <table width="100%" id="TABLE1">
                <tr>
                  ...
                  <td width="425px"><table style="width: 100%">
                      <tr>
                        <td style="width: 76px" >Date &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; <strong>:</strong></td>
                        <td height="26">
                                  <asp:Label ID="lbl_date" runat="server" Text=""></asp:Label></td>
                      </tr>
                      <tr>
                        <td style="width: 76px; height: 39px;">Course&nbsp; &nbsp;<strong>:</strong> </td>
                        <td style="height: 39px"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" class="border">
                            <tr>
          ...
          <table width="100%" style="height:110px;" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr><td style="width: 9px; height: 38px;"></td>
                 <td colspan="2" style="height: 38px">*Cheque Subject to realization<br /> *Fees Once Paid will not be refunded 
                            <asp:Label ID="lbl_address" runat="server" Text="Label" Font-Bold="True"></asp:Label></td>
                 </tr>
            ...
            <tr style="height: 25px">
                <td align="center" colspan="2" style="height: 25px">
                    <span style="font-size: 10pt"><strong>Franchisor: IMAGE INFOTAINMENT LIMITED,
                        <?xml namespace="" ns="urn:schemas-microsoft-com:office:office" prefix="o" ?><o:p></o:p></strong></span></td>
            </tr>
      <tr style="height:25px;">
                        <td style="height:25px;" colspan="2" align="center">
                            &nbsp;<span style="font-size: 24pt"><span style="font-size: 9pt; font-family: 'Arial','sans-serif'">Regd
                                Office No:32,
                                <?xml namespace="" ns="urn:schemas-microsoft-com:office:smarttags" prefix="st1" ?><st1:street w:st="on"><st1:address w:st="on">TTK 
                  Road</st1:address></st1:street>, Alwarpet, Chennai 600 018. Ph: 4293 5293.<o:p></o:p></span></span></td>
                    </tr>
                <tr style="height: 25px">
        ...
        <td colspan="2" align="center" valign="middle">
          ...
          <tr>
            ...
            <td width="600px"><table width="100%" align="CENTER">
              ...
              <tr>
                <td class="style3 style5" align="center" valign="middle"><div align="" class="style5 style1">
                    <span style="font-size: 16pt"><strong>&nbsp; &nbsp;<span style="font-size: 18pt">VNXTL
                        TECH SERVICES PVT LTD<o:p></o:p></span></strong></span></div>
                </td>
              </tr>
              <tr>
                <td class="style3" align="left" valign="middle">
                    <p align="center" class="MsoNormal" style="margin: 0in 0in 0pt; text-align: center">
                        <span style="font-size: 9pt; font-family: 'Arial','sans-serif'"><strong>LAV Arcade,
                            ...
                            <st1:city w:st="on"><st1:place 
                                w:st="on">Bangalore</st1:place></st1:city>
                            560 032. Ph: 4128 4111<o:p></o:p></strong></span></p>
                </td>
              </tr>
              <tr>
                <td class="style3" align="center" valign="middle">
                    <span style="font-size: 9pt; font-family: 'Arial','sans-serif'; mso-fareast-font-family: 'Times New Roman';
                        mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">
                        <strong>Service Tax Regn. No: AADCV5893NST001</strong></span></td>
              </tr>
                ...
                <tr>
                  <td width="140"><table>
                    <tr>
                      ...
                      <tr>
                        <td style="height: 49px">Inv.No<strong>:</strong></td>
                        
                        <td style="height: 49px"><table width="80" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #333;">
                  ...
                  <td width="425px"><table style="width: 100%">
                      ...
                      <tr>
                        <td style="width: 65px; height: 48px;">Course <strong>:</strong> </td>
                        <td style="height: 48px"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" class="border">
                            <tr>
          ...
          <table width="100%" style="height:110px;" border="0" cellpadding="0" cellspacing="0">
                ...
                <asp:Label ID="lbl_address1" runat="server" Text="Label" Font-Bold="True"></asp:Label></td>
                 </tr>
              </table>
                       <tr style="height:25px;">
                        <td style="height:25px;" colspan="2" align="center">
