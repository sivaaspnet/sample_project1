<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="Dumpoldbatch.aspx.cs" Inherits="superadmin_dumpoldBatch" Title="Custom Batch" %>
...
function changepayment()
 ...
 if(document.getElementById("ContentPlaceHolder1_DropDownList1").value=="-1,2,3,4,5,6,7")
 {
  document.getElementById("ContentPlaceHolder1_CheckBoxList3").style.display=''; 
 }
 else
 {
  document.getElementById("ContentPlaceHolder1_CheckBoxList3").style.display='none'; 
 }
 }
...
//         }
         ...
         else if(document.getElementById("ContentPlaceHolder1_DropDownList1").value=="0,2,3,4,5,6,7" || document.getElementById("ContentPlaceHolder1_DropDownList1").value=="6,7")
         {  
 ...
 <div class="free-forms">
         <table class="common" id="getdetails"  runat="server" width="100%">
             ...
             <tr>
                 ...
                 <td style="">
                         ...
                         <asp:ListItem Value="6,7">WEEKEND</asp:ListItem>
                          <asp:ListItem Value="-1,2,3,4,5,6,7">Custom</asp:ListItem>
                     </asp:DropDownList>
             ...
             <tr><td style="" >
                 ...
                 &nbsp; &nbsp;&nbsp;&nbsp;</td><td style="">
                     &nbsp;<asp:TextBox ID="txt_stratdate"  CssClass="text datepicker" onpaste="return false" onKeyPress="return false" MaxLength="10" runat="server" Width="140px"></asp:TextBox>
                 &nbsp; &nbsp; &nbsp;</td>
             </tr>
             <tr>
                 <td style="">
