<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="Ipad-Dashboard.aspx.cs" Inherits="superadmin_Dashboard" Title="Dashboard" %>
     ...
     <table width="500" class="common">
        ...
        <tr id="visdate" runat="server" visible="false">
            <td style="width: 260px" >
                From Date
                <asp:TextBox ID="txtfromcalender2" onpaste="return false" runat="server" onkeypress="return AllowAlphabet(event)" CssClass="text datepicker" Width="92px"></asp:TextBox>
                 
             
                </td>
            <td>
                To Date
                <asp:TextBox ID="txttocalender2" onpaste="return false" runat="server" onkeypress="return AllowAlphabet(event)" CssClass="text datepicker" Width="92px"></asp:TextBox>&nbsp;
