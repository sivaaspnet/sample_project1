<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="zipBatch.aspx.cs" Inherits="superadmin_createnewBatch" Title="Custom Batch" %>
       ...
       if (checkboxdepta[ii].checked)
        {
         ...
         {    
             ...
             alert("Please select batch time");
             return false;
         }else if(document.getElementById("ContentPlaceHolder1_ddlbatch0").value == document.getElementById("ContentPlaceHolder1_ddlbatch").value)
         {    
