<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="regularcollectionreport.aspx.cs" Inherits="superadmin_outstandingreport" Title="RegularCollection Report" %>
...
<style type="text/css">
    ...
    <h3 class="cont-title"> Regular Projection Report</h3>
   <%-- <div class="breadcrumps">
      <ul>
        <li><a href="DashboardV2.aspx">Dashboard</a>/</li>
        <li><a>Reports</a>/</li>
        <li><a href="regularcollectionreport.aspx" class="last">Regular Projection Report</a></li>
      </ul>
    </div>
    <div class="clear"></div>--%>
  </div>
    <div class="search-sec-cont">
         <ul>
      <li><div class="wth-1">Select Month & Year :</div>
        <div class="wth-2"> <asp:DropDownList ID="ddlmonth" runat="server" CssClass="sele-txt" >
              ...
              <asp:DropDownList ID="ddlyear" runat="server"  CssClass="sele-txt">
              ...
              <li><div class="wth-1">Payment Status :</div>
        <div class="wth-2"> <asp:DropDownList ID="ddl_status" runat="server"  CssClass="sele-txt">
                   ...
                   <li>
        <asp:Button ID="view" runat="server" CssClass="search-btn" Text="Search"  OnClick="view_Click"  OnClientClick="javascript:return validview();"/>
      </li>
...
<div id="collectiongrid" runat="server" class="analysis-sec">
    <ul>
    ...
    <div class="clear"></div>
       ...
       <asp:GridView ID="Gridview_admission" runat="server" CssClass="tbl-cont3" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="InitialTax">
                    <ItemTemplate>
      ...
      <div align="center" style="padding:0px 15px 15px 15px;"><asp:LinkButton ID="LinkButton1" runat="server" Visible="false" CssClass="download-btn" OnClick="LinkButton1_Click">Download Excel</asp:LinkButton></a></div>
