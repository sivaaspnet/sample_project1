<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receiptprint1.aspx.cs" Inherits="superadmin_Receiptprint" %>
      ...
      <tr>
                    ...
                    <div align="center">
                        <p align="center" class="MsoNormal" style="margin: 0in 0in 0pt; text-align: center">
                            <span style="font-size: 9pt; font-family: 'Arial','sans-serif'"><strong>LAV Arcade,
                                ...
                                Bangalore 560 032. Ph: 4128 4111<?xml namespace="" ns="urn:schemas-microsoft-com:office:office"
                    ...
                    <div align="center">
                        <p align="center" class="MsoNormal" style="margin: 0in 0in 0pt; text-align: center">
                            <span style="font-size: 9pt; font-family: 'Arial','sans-serif'"><strong>Service Tax
                                Regn. No: AADCV5893NST001</strong></span>&nbsp;</p>
                    </div>
                </td>
              </tr>
          ...
          <table width="700px" style="height:150px;" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="510" style="height: 150px" ><table width="357" height="116" border="0" cellspacing="0" align="right" >
                      <tr>
                        <td align="center">For <strong>VNXTL TECH SERVICES PVT LTD</strong><table align="right" style="font-weight: bold">
                            </table>
                        </td>
                      </tr>
                      <tr>
        ...
        <tr>
            ...
            <td align="center" valign="middle">
                    <input id="Button1" class="submit" onclick="window.open('Receiptprintpage1.aspx?studid=<%=lblstudid.Text%>&recptno=<%=lbl_recpno.Text%>&page=<%=HiddenField1.Value%>','PrintMe','height=500px,width=600px,scrollbars=1')"
