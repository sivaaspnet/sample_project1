...
public partial class superadmin_createnewBatch : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (hdnSlot.Value.Trim().ToString() != "")
        {
        ...
        if (!IsPostBack)
        {
            ...
            fillcoursedropdown();
            lblmsg1.Text = "";
            txt_stratdate.Text = DateTime.Now.ToString("dd-MM-yyyy");
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
     {
         ...
         if (ddlBatchSlot.SelectedValue == "MWF")
         {
             slotdate = "2,4,6";
         }
         else if (ddlBatchSlot.SelectedValue == "TTS")
         {
             slotdate = "3,5,7";
         }
         else if (ddlBatchSlot.SelectedValue == "Daily")
         {
             slotdate = "2,3,4,5,6,7";
         }
         else if (ddlBatchSlot.SelectedValue == "ZIP")
         {
             slotdate = "0,2,3,4,5,6,7";
         }
         else if (ddlBatchSlot.SelectedValue == "WEEKEND")
         {
         ...
         else if (ddlBatchSlot.SelectedValue == "WEEKEND 2Hr")
         {             
             for (int i = 0; i < CheckBoxList2.Items.Count; i++)
             {
                 if (CheckBoxList2.Items[i].Selected)
         ...
         else if(ddlBatchSlot.SelectedValue == "Custom")
         {
              for (int i = 0; i < CheckBoxList3.Items.Count; i++)
             {
                 if (CheckBoxList3.Items[i].Selected)
                 {
                     values += CheckBoxList3.Items[i].Value + ",";
         ...
         if (ddlBatchSlot.SelectedItem.Text == "ZIP" || ddlBatchSlot.SelectedItem.Text == "WEEKEND" || ddlBatchSlot.SelectedItem.Text == "WEEKEND 2Hr")
         {
             _Qry1 = "select convert(varchar,classdate,101) as classdate from [spzipclassdate] ('" + sdate + "','" + slotdate + "','" + os + "','" + ddl_coursename.SelectedValue + "')";
...
sce.batchtiming in ('" + ddlbatch.SelectedValue.ToString() + "','" + ddlbatch0.SelectedValue.ToString() + "')  and   facultyid='" + ddlfac.SelectedValue + "' and   sce.centrecode='" + Session["SA_centre_code"].ToString() + "' and convert(varchar(10),dateadd(d,0,sce.classdate),101)  in (" + classdate + ") and sts.status='Pending' and sce.batchstatus='active'";
        ////Response.Write(_Qry+"<br>");
         ...
         else
         {
             ...
             if(Convert.ToInt32(hdnfreesystem.Value)>0)
             {
                 ...
                 if (ddlBatchSlot.SelectedItem.Text != "ZIP" || ddlBatchSlot.SelectedItem.Text != "WEEKEND")
                 {
                     batchqry += " INSERT INTO [erp_batchdetails] ([software_id],[batchCode],[moduleId],[NoOfClass],[centreCode],[slot],[batchTiming],[status],[dateins],[slotday]) VALUES ('" + os + "','" + batch_code + "','" + ddl_coursename.SelectedValue + "','" + noofclass + "','" + Session["SA_centre_code"].ToString() + "','" + ddlBatchSlot.SelectedItem.Text + "','" + ddlbatch.SelectedValue + "','pending',getdate(),'" + slotdate + "') ";

                 }
                 else
                 {
                     batchqry += " INSERT INTO [erp_batchdetails] ([software_id],[batchCode],[moduleId],[NoOfClass],[centreCode],[slot],[batchTiming],[status],[dateins],[slotday]) VALUES ('" + os + "','" + batch_code + "','" + ddl_coursename.SelectedValue + "','" + noofclass + "','" + Session["SA_centre_code"].ToString() + "','" + ddlBatchSlot.SelectedItem.Text + "','" + ddlbatch.SelectedValue + "," + ddlbatch0.SelectedValue + "','pending',getdate(),'" + slotdate + "') ";
                ...
                lblslot.Text = ddlBatchSlot.SelectedItem.Text;
    ...
    private void fillfree()
    {
        ...
        sdatetest = splittest[2] + "-" + splittest[1] + "-" + splittest[0];
            ...
            if(ddlBatchSlot.SelectedItem.Text=="MWF")
            {
                   valuesmwf = "2,4,6";
                   values = "2,4,6";
            }
            else if (ddlBatchSlot.SelectedItem.Text == "TTS")
            {
                valuestts = "3,5,7";
                values = "3,5,7";
            }
            else if (ddlBatchSlot.SelectedItem.Text == "Daily")
            {
                valuesmwf = "2,4,6";
                valuestts = "3,5,7";
                values = "2,3,4,5,6,7";
            }
            else if (ddlBatchSlot.SelectedItem.Text == "ZIP")
            {
                valuesmwf = "2,4,6";
                valuestts = "3,5,7";
                values = "2,3,4,5,6,7";
            }
            else if (ddlBatchSlot.SelectedItem.Text == "WEEKEND")
            {
                valuesmwf = "6";
                valuestts = "7";
                values = "6,7";
            }
            else if (ddlBatchSlot.SelectedItem.Text == "WEEKEND 2Hr")
            {
                valuesmwf = "6";
                valuestts = "7";
                values = "6,7";
            }
            else if (ddlBatchSlot.SelectedItem.Text == "Custom")
            {
                for (int i = 0; i < CheckBoxList3.Items.Count; i++)
                {
                    if (CheckBoxList3.Items[i].Selected)
                    {
                        ...
                        if (Convert.ToInt32(CheckBoxList3.Items[i].Value) == 2 || Convert.ToInt32(CheckBoxList3.Items[i].Value) == 4 || Convert.ToInt32(CheckBoxList3.Items[i].Value) == 6)
                        {
                            valuesmwf += CheckBoxList3.Items[i].Value + ",";
                        }
                        if (Convert.ToInt32(CheckBoxList3.Items[i].Value) == 3 || Convert.ToInt32(CheckBoxList3.Items[i].Value) == 5 || Convert.ToInt32(CheckBoxList3.Items[i].Value) == 7)
                        {
                            valuestts = CheckBoxList3.Items[i].Value + ",";
                        }
                    }
                }
       ...
       // _Qry = "select batchtiming,max(ss)  as batchedsystem,labid from (select  classdate,batchtiming,count(labId) as ss,labId from erp_batchSchedule where   convert(varchar(10),dateadd(d,0,classdate),101) in (" + classdate + ") and centrecode='" + Session["SA_centre_code"].ToString() + "' group by classdate,batchtiming,labId) as ss group by batchtiming,labid";
        ...
        DataTable freelab = new DataTable();
           ...
           // gvlab.DataBind();
            ...
            _Qry1 = "select convert(varchar,classdate,101) as classdate from [spzipclassdate]('" + sdate + "','" + values + "','" + os + "','" + ddl_coursename.SelectedValue + "')";
            //  Response.Write(_Qry1+"<br/>");
        ...
        if (countmod > 0)
        {
          ...
          // Response.End();
            ...
            else
            {
                ...
                if (ddlBatchSlot.SelectedItem.Text == "Custom")
                {
                ...
                {
                    _Qry = "select count(batchtime) from erp_facultytimedetails where facultyid='" + ddlfac.SelectedValue + "' and batchtime in ('" + ddlbatch.SelectedValue.ToString() + "','" + ddlbatch0.SelectedValue.ToString() + "') and day in (" + slotdate + ")";
                }
              // Response.Write(_Qry+" --first--<br>");
             // Response.End();
                int count = 0;            
                count = MVC.DataAccess.ExecuteScalar(MVC.DataAccess.ConnectionString, _Qry);
                if ((ddlBatchSlot.SelectedItem.Text == "Custom") || (count == 6 && ddlBatchSlot.SelectedItem.Text == "Daily") || (count == 3 && ddlBatchSlot.SelectedItem.Text == "MWF") || (count == 3 && ddlBatchSlot.SelectedItem.Text == "TTS") || (count == 12 && ddlBatchSlot.SelectedItem.Text == "ZIP") || (count == 4 && ddlBatchSlot.SelectedItem.Text == "WEEKEND") || (count == 2 && ddlBatchSlot.SelectedItem.Text == "WEEKEND 2Hr"))
                {
                    if (ddlBatchSlot.SelectedItem.Text == "Custom")
                    {
                    ...
                    {
                        _Qry = "select count(facultyid) from erp_batchschedule sce inner join erp_batchcontentstatus sts on sts.batchcode=sce.batchcode where sce.batchtiming in ('" + ddlbatch.SelectedValue.ToString() + "','" + ddlbatch0.SelectedValue.ToString() + "') and facultyid='" + ddlfac.SelectedValue + "' and sce.centrecode='" + Session["SA_centre_code"].ToString() + "' and convert(varchar(10),dateadd(d,0,sce.classdate),101)  in (" + classdate + ") and sts.status='Pending' and sce.batchstatus='active' ";
                    }
                   // Response.Write(_Qry);
                   // Response.End();
                    count = MVC.DataAccess.ExecuteScalar(MVC.DataAccess.ConnectionString, _Qry);
    ...
    protected void ddl_coursename_SelectedIndexChanged(object sender, EventArgs e)
    {
     ...
     ///   ScriptManager.RegisterStartupScript(this, this.GetType(), "asddas", "getjquerydate();", true);
        ...
        //if (ddl_coursename.SelectedIndex > 0)
        //{
        //    CheckBoxList3.Visible = false;
        //    ddlBatchSlot.Items.Remove(new ListItem("Custom", "0"));
        //    if ((ddl_coursename.SelectedItem.Text.ToLower().Contains("bsc")) || (ddl_coursename.SelectedItem.Text.ToLower().Contains("b.sc")))
        //    {
        //        CheckBoxList3.Visible = true;             
        //        ddlBatchSlot.Items.Add(new ListItem("Custom","0"));
        //        ddlBatchSlot.SelectedValue = "0";
        //    }
        //}
