<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ganganagar.aspx.cs" Inherits="superadmin_Receiptprint1" %>
...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td >
    <table width="650px"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
      <tr>
        <td width="600" style="height: 600px">
        <table width="600"  border="0">
          <tr>
            <td width="291" ><img src="../layout/image_logo.jpg" width="178" height="95" /></td>
            <td style="width: 419px"><table align="CENTER" id="TABLE1" style="width: 458px">
              <tr>
                <td class="style3 style5" style="height: 38px; width: 454px;"><div align="center" class="style5 style1"> <span style="font-size: 24pt"><strong>&nbsp;
                        &nbsp;&nbsp; </strong>
                    <p align="center" class="MsoNormal" style="margin: 0in 0in 0pt; text-align: center">
                        <span style="font-size: 18pt"><strong>VNXTL TECH SERVICES PVT LTD<?xml namespace="" ns="urn:schemas-microsoft-com:office:office"
                            prefix="o" ?><o:p></o:p></strong></span></p>
                </span></div></td>
              </tr>
              <tr>
                <td class="style3" style="width: 454px"><div align="center">
                    <p align="center" class="MsoNormal" style="margin: 0in 0in 0pt; text-align: center">
                        <span style="font-size: 9pt; font-family: 'Arial','sans-serif'"><strong>LAV Arcade,
                            ...
                            <st1:street w:st="on"><st1:address w:st="on">#79, 
                        Bellary Road</st1:address></st1:street>
                            , Ganga Nagar,
                            <st1:city w:st="on"><st1:place 
                        w:st="on">Bangalore</st1:place></st1:city>
                            560 032. Ph: 4128 4111<?xml namespace="" ns="urn:schemas-microsoft-com:office:office"
                                prefix="o" ?><o:p></o:p></strong></span></p>
                </div></td>
              </tr>
              <tr>
                <td class="style3" style="width: 454px; height: 14px;"><div align="center">
                    <p align="center" class="MsoNormal" style="margin: 0in 0in 0pt; text-align: center">
                        <span style="font-size: 9pt; font-family: 'Arial','sans-serif'"><strong>Service Tax
                            Regn. No: AADCV5893NST001<o:p></o:p></strong></span></p>
                    &nbsp;</div></td>
              </tr>
            </table></td>
          </tr>
              ...
              <table style="width: 108%">
                <tr>
                  ...
                  <td align="center" style="width: 282px"><strong><u>RECEIPT</u></strong></td>
                  <td style="width: 303px"><table style="width: 325px">
                      <tr>
                        <td style="width: 30px" valign="middle">Date<strong>:</strong></td>
                      ...
                      <tr>
                        <td style="width: 30px">Course <strong>:</strong> </td>
                  ...
                  <tr>
                      <td colspan="3" style="height: 30px" valign="middle">
                          ...
                          <asp:Label ID="lbl_ddcc" runat="server" Font-Bold="True"></asp:Label>&nbsp;</td>
                  </tr>
                  <tr>
                      <td colspan="3" style="height: 30px" valign="middle">
                          <asp:Label ID="lbl_Bank" runat="server" Visible="False"></asp:Label><asp:Label ID="lbl_BankName"
                              runat="server" Font-Bold="True" Visible="False"></asp:Label>being payment towards
          ...
          <table width="600" style="height:150px;" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="510" style="height: 150px" ><table width="357" height="116" border="0" cellspacing="0" align="right" >
                      <tr>
                        <td align="center">For <strong>VNXTL TECH SERVICES PVT LTD</strong><table width="" align="right" style="font-weight: bold">
                          </table></td>
                      </tr>
                      <tr>
          ...
          <table>
            ...
            <td align="center" valign="middle">
                    <input id="Button1" class="submit" onclick="window.open('gangaprintpage.aspx?studid=<%=lblstudid.Text%>&recptno=<%=lbl_recpno.Text%>','PrintMe','height=500px,width=600px,scrollbars=1')"
