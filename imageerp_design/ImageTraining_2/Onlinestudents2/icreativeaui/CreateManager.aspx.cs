...
public partial class superadmin_CreateManager : System.Web.UI.Page
{
    ...
    private void fillgrid()
    {
        ...
        _Qry = "select masterpassword,password,a.userid,b.centre_location,a.centrelogin_id,a.username,a.centre_useremail,a.role,b.centre_id,b.centre_code,b.centre_region,b.centre_category,a.login_status from img_centredetails b inner join img_centrelogin a on a.centre_code=b.centre_code where role='CentreManager'  order by centre_id desc";
    ...
    protected void grdcentre_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            _Qry = "select a.userid,b.centre_location,a.centrelogin_id,a.username,a.centre_useremail,a.role,b.centre_id,b.centre_code+'#'+cast(b.centre_id as varchar) as code_id    ,b.centre_region,b.centre_category,a.login_status from img_centredetails b inner join img_centrelogin a on a.centre_code=b.centre_code where a.centrelogin_id=" + e.CommandArgument.ToString() + "";
