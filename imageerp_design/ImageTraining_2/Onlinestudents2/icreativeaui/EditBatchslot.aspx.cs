...
onlinestudentsfacultydetails fac on fac.faculty_id=sce.facultyid 
 where  bat.centrecode='" + Session["SA_centre_code"].ToString() + "' and year(sce.classdate)='" + ddlyear.SelectedValue + "' ";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (ddlslot.SelectedValue.ToUpper() == "MWF")
        {
            slotdate = "2,4,6";
        }
        else if (ddlslot.SelectedValue.ToUpper() == "TTS")
        {
            slotdate = "3,5,7";
        }
        else if (ddlslot.SelectedValue.ToUpper() == "DAILY")
        {
            slotdate = "2,3,4,5,6,7";
        }
        else if (ddlslot.SelectedValue.ToUpper() == "ZIP")
        {
            slotdate = "0,2,3,4,5,6,7";
        }
        else if (ddlslot.SelectedValue.ToUpper() == "WEEKEND")
        {
            slotdate = "6,7";
        }
        else if (ddlslot.SelectedValue.ToUpper() == "WEEKEND 2HR")
        {
            slotdate = "6,7";
        }
        int batchedsystem = 0;
       ...
       // Response.Write(_Qry+"<br>");
        ...
        if ((ddlslot.SelectedValue.ToUpper() == "CUSTOM") || (count == 6 && ddlslot.SelectedValue.ToUpper() == "DAILY") || (count == 3 && ddlslot.SelectedValue.ToUpper() == "MWF") || (count == 3 && ddlslot.SelectedValue.ToUpper() == "TTS") || (count == 12 && ddlslot.SelectedValue.ToUpper() == "ZIP") || (count == 4 && ddlslot.SelectedValue.ToUpper() == "WEEKEND") || (ddlslot.SelectedValue.ToUpper() == "WEEKEND 2HR"))
        {
            if (ddlslot.SelectedValue.ToUpper() == "CUSTOM")
            {
    ...
    protected void btnconform_Click(object sender, EventArgs e)
    {
        ...
        else if (ddlslot.SelectedValue.ToUpper() == "CUSTOM")
        {
            //lblmsg1.Text = "Contact Admin";
        ...
        if (ddlslot.SelectedValue.ToUpper() != "ZIP" || ddlslot.SelectedValue.ToUpper() != "WEEKEND")
        {
 ...
 where  bat.centrecode='" + Session["SA_centre_code"] + "' and bat.batchcode='" + e.CommandArgument.ToString() + "'  ";
                ...
                if (dt.Rows.Count > 0)
                {
                    if (dt.Rows[0]["status"].ToString() == "pending" || dt.Rows[0]["status"].ToString() == "Pending")
                    {
                        ...
                        ddlslot.SelectedValue = dt.Rows[i]["slot"].ToString().ToUpper();
