<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="EditBatchslot1.aspx.cs" Inherits="superadmin_EditBatchslot1" Title="Edit Batch" %>
...
function changepayment()
 ...
 if(document.getElementById("ContentPlaceHolder1_ddlslot").value=="0,2,3,4,5,6,7" ||  document.getElementById("ContentPlaceHolder1_ddlslot").value=="6,7")
 {
 ...
 document.getElementById("ContentPlaceHolder1_dayslot").style.display='none'; 
  ...
  if(document.getElementById("ContentPlaceHolder1_ddlslot").value=="6,7")
 {
 ...
 else
 {
  ...
  /*if(document.getElementById("ContentPlaceHolder1_ddlslot").value=="Zip")

 {
  document.getElementById("ContentPlaceHolder1_batchtime").style.display=''; 
 }
 else
 {
 document.getElementById("ContentPlaceHolder1_ddlbatch0").value=document.getElementById("ContentPlaceHolder1_ddlbatch").value;
 document.getElementById("ContentPlaceHolder1_batchtime").style.display='none'; 
 }*/
    ...
    <table id="getdetails" runat="server" visible="false" class="common" width="100%">
        ...
        <tr>
            ...
            <td style="">
                &nbsp;<asp:DropDownList ID="ddlslot" runat="server" Width="150px" onChange="changepayment()">
        ...
        <tr>
           ...
           <tr id="batchtime" style="display:none;">
            <td style="">
                &nbsp;<asp:Label ID="Label8" runat="server" Text="Batch Time"></asp:Label></td>
            <td style="">
                &nbsp;<asp:DropDownList ID="ddlbatch0" runat="server" Width="150px">
                    <asp:ListItem Value="7AMto9Am">7AM to 9Am</asp:ListItem>
                    <asp:ListItem Value="9AMto11Am">9AM to 11Am</asp:ListItem>
                    <asp:ListItem Value="11AMto1PM">11AM to 1PM</asp:ListItem>
                    <asp:ListItem Value="1PMto3PM">1PM to 3PM</asp:ListItem>
                ...
                <table class="common" id="tblstudent" visible="true" runat="server" width="100%" >
                    <tr>
                        <td colspan="4" style="padding:0px;" >
                            <h4>
                    Batch details<asp:HiddenField ID="HiddenField2" runat="server" />
                                        </h4>
                        </td>
                    </tr>
             <tr>
