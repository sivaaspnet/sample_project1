<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="outstandingreport.aspx.cs" Inherits="superadmin_outstandingreport" Title="Outstanding Report" %>
        ...
        <asp:Label ID="lblmessage" CssClass="error" runat="server" Text=""></asp:Label></td>
          ...
          <br />
              <asp:Label ID="Label1" runat="server" Text="Find By"></asp:Label>&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox1"
                  ...
                  <br />
                  <br />
       <asp:GridView ID="Gridview_admission" runat="server" CssClass="common" AutoGenerateColumns="False" AllowPaging="true" PageSize="20" OnPageIndexChanging="Gridview_admission_PageIndexChanging" EmptyDataText="No records Found" Width="100%" >
            <Columns>
                ...
                <asp:TemplateField HeaderText="Due Date">
                 ...
                 <asp:TemplateField HeaderText="Invoice No">
                    <ItemTemplate>
                       <a target="_blank" title="Click to see invoice" href="InvoiceDetails.aspx?invno=<%#Eval("invoice")%>"><%#Eval("invoice")%></a>
                    </ItemTemplate>
                </asp:TemplateField>
