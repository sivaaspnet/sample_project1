...
public partial class Onlinestudents2_superadmin_staff : System.Web.UI.Page
{
    ...
    private void gridtable()
    {
        ...
        lbl_month.Text = DropDownList1.SelectedValue;
            ...
            string tab = "<table border='1' style=' border-collapse:collapse ' class='common' width='100%'><tr  align='center'><td colspan='3'>" + DropDownList1.SelectedItem.Text + "</td><td></td><td colspan='3' align='center'>" + year + "</td></tr><tr style='font-weight:bold '><td>Day</td><td>7AM - 9AM</td><td>9AM - 11Am</td><td>11AM-1PM</td><td>1PM-3PM</td><td>3PM-5PM</td><td>5PM-7PM</td></tr>";
