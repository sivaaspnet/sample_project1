...
public partial class superadmin_ChangeInvoiceedit : System.Web.UI.Page
{
    int check = 0;
    ...
    protected void Button3_Click1(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow grd in GridView1.Rows)
        {
            ...
            //Response.Write("<br/>InstalAmt Is:" + instalamt);
            //Response.Write("<br/>Install Amount Is:" + updtxt.Text);
            //Response.End();
            ...
            //Response.Write("<br/>instal_tax Is:" + updtxt.Text);
            //Response.Write("<br/>totinstal_tax Amount Is:" + adjust.Text);
        ...
        //Response.Write("Course Fees Is:" + lblcoursefee.Text);
        //Response.End();
