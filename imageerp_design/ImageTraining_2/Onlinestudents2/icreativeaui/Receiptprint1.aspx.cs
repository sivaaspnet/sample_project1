...
public partial class superadmin_Receiptprint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            dt84 = MVC.DataAccess.ExecuteDataTable(_Qry);
            if (dt84.Rows.Count > 0)
            {
                string val = dt84.Rows[0]["center_code"].ToString();
                if (Session["SA_centre_code"].ToString() == val)
                {
                    //lbl_address.Text = dt84.Rows[0]["center_address"].ToString();
   ...
   private void FillInvoice()
    {
            ...
            else
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (dt84.Rows.Count > 0)
                    {
                        ...
                        if (Session["SA_centre_code"].ToString() == val)
                        {
                            checkrec_no = Convert.ToInt32( dt84.Rows[0]["last_receipt"].ToString());
                    ...
                    //Response.Write("rec_No Is:" + checkrec_no);
        ...
        else
        {
                ...
                if (dts.Rows.Count > 0)
                {
                    ...
                    lbl_recpno.Text = Request.QueryString["rec_no"];
