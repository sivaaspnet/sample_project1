<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="createnewBatch.aspx.cs" Inherits="superadmin_createnewBatch" Title="Create New Batch"  EnableEventValidation="false"%>
...
function changebatchslot()
 {

 if(document.getElementById('<%= this.ddlBatchSlot.ClientID %>').value=="ZIP" ||  document.getElementById('<%= this.ddlBatchSlot.ClientID %>').value=="WEEKEND")
 {
  document.getElementById('<%= this.dayslot.ClientID %>').style.display=''; 
   document.getElementById('<%= this.hdnSlot.ClientID %>').value=document.getElementById('<%= this.ddlBatchSlot.ClientID %>').value
 }   
 else
 {
  document.getElementById('<%= this.ddlbatch0.ClientID %>').value=document.getElementById('<%= this.ddlbatch.ClientID %>').value;

   document.getElementById('<%= this.dayslot.ClientID %>').style.display='none'; 
  document.getElementById('<%= this.hdnSlot.ClientID %>').value="";
 }
 
 if(document.getElementById('<%= this.ddlBatchSlot.ClientID %>').value=="Custom")
 {
  document.getElementById('<%= this.CheckBoxList3.ClientID %>').style.display=''; 
 }
 else
 {
  document.getElementById('<%= this.CheckBoxList3.ClientID %>').style.display='none'; 
 }
 if(document.getElementById('<%= this.ddlBatchSlot.ClientID %>').value=="WEEKEND")
 {
  document.getElementById('<%= this.CheckBoxList2.ClientID %>').style.display=''; 
 }
 else if(document.getElementById('<%= this.ddlBatchSlot.ClientID %>').value=="WEEKEND 2Hr")
 {
  document.getElementById('<%= this.CheckBoxList2.ClientID %>').style.display=''; 
 }
 else
 {
  document.getElementById('<%= this.CheckBoxList2.ClientID %>').style.display='none'; 
 }
...
//        }
        ...
        if(document.getElementById("ContentPlaceHolder1_ddl_coursename").value=="")
         ...
         else if(document.getElementById("ContentPlaceHolder1_ddlBatchSlot").value=="Select")
         {    
             document.getElementById("ContentPlaceHolder1_ddlBatchSlot").value=="Select";
             document.getElementById("ContentPlaceHolder1_Label1").innerHTML = '*Please select batch time!';
             document.getElementById("ContentPlaceHolder1_ddlBatchSlot").focus();
             document.getElementById("ContentPlaceHolder1_ddlBatchSlot").style.border="#ff0000 1px solid";
             document.getElementById("ContentPlaceHolder1_ddlBatchSlot").style.backgroundColor="#e8ebd9";
             return false;
         } 
...
function chkvalid()
{
      ...
      var TargetBaseControl = document.getElementById('<%= this.Gridvw.ClientID %>');
...
//}
       ...
       if (checkboxdepta[ii].checked)
        {
         ...
         {    
          ...
          else if(document.getElementById("ContentPlaceHolder1_ddlBatchSlot").value=="")
         {    
             document.getElementById("ContentPlaceHolder1_ddlBatchSlot").focus();
             document.getElementById("ContentPlaceHolder1_ddlBatchSlot").style.border="#ff0000 1px solid";
             document.getElementById("ContentPlaceHolder1_ddlBatchSlot").style.backgroundColor="#e8ebd9";
         ...
         else if(document.getElementById("ContentPlaceHolder1_ddlBatchSlot").value=="6,7")
         {  
 ...
 <div class="free-forms">
  <table class="common" id="getdetails"  runat="server" width="100%" >
             ...
             <tr>
                 <td style="">
                     &nbsp;Slot</td>
                 <td style="">
                         <asp:DropDownList ID="ddlBatchSlot" runat="server" Width="159px" onChange="changebatchslot()">
                    ...
                    <asp:CheckBoxList ID="CheckBoxList3" runat="server" RepeatDirection="Horizontal"  style="display:none">
             ...
             <tr>
                 ...
                 <td style="">
                     ...
                     <div id="dayslot"   runat="Server" style="display:none;float:right;">
                     Second Batch Time : <asp:DropDownList ID="ddlbatch0" runat="server" 
                         Width="150px">
                         <asp:ListItem Value="7AMto9Am">7AM to 9Am</asp:ListItem>
                         <asp:ListItem Value="9AMto11Am">9AM to 11Am</asp:ListItem>
                         <asp:ListItem Value="11AMto1PM">11AM to 1PM</asp:ListItem>
  ...
  <table width="100%"> 
  <tr>
   <td align="center" > <asp:Button ID="Button2" runat="server" CssClass="btnStyle1" OnClientClick="javascript:return SearchValidate();" OnClick="Button2_Click" Text="Check Availability"/>
             
                <asp:HiddenField ID="hdnfreesystem" runat="server" />   
                 </td>
             </tr>
             <tr visible="false"  class="no-borders">
                 <td colspan="3">
