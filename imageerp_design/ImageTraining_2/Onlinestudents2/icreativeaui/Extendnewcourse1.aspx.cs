...
public partial class ImageTraining_2_Onlinestudents2_superadmin_Extendnewcourse : System.Web.UI.Page
{
    ...
    {
        qry = "select cd.course_id,cd.program,instal_amount,(cd.program +' ('+instal_amount + ')') as feeprogram from img_centre_coursefee_details as feed inner join img_coursedetails as cd on feed.program=cd.course_id and track='Normal' and feed.centre_code='" + Session["SA_centre_code"].ToString() + "'";
