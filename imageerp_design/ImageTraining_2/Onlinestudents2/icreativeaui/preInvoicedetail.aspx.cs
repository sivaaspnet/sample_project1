                ...
                else
                {
                    ...
                    if (txtinstalldate.Text != "" && txtdate.Text != "")
                    {
                        if (txtamountpaid.Text != "")
                        {
                            ...
                            cmd.Parameters.AddWithValue("studentid", Request.QueryString["studid"].ToString());
                            ...
                            ////Response.Write("centrecode " + Session["SA_centre_code"]);
                            ////Response.Write("<br/>studName " + txtname.Text);
                            ////Response.Write("<br/>course " + txtcourseid.SelectedValue);
                            ////Response.Write("<br/>installmenttype " + installType);
                            ////Response.Write("<br/>initialAmt " + txtamountpaid.Text);
                            ////Response.Write("<br/>studentid " + Request.QueryString["studid"].ToString());
                            ////Response.Write("<br/>invoiceNo " + no);
                            ////Response.Write("<br/>noofInstallment " + txtinstall.Text);
                            ////Response.Write("<br/>batchTime " + time);
                            ////Response.Write("<br/>cashType " + CashType);
                            ////Response.Write("<br/>bankname " + bank);
                            ////Response.Write("<br/>chequeNo " + dd);
                            ////Response.Write("<br/>chequeDt " + dd);
                            ////Response.Write("<br/>userId " + Session["SA_userID"]);
                            ////Response.Write("<br/>installmentDate " + datet2);
                            ////Response.Write("<br/>coursestartdate " + datet);
                            ////Response.End();
...
img_enquiryform  b on a.enq_number =b.enq_number where student_id='" + Request.QueryString["studid"] + "'";
    ...
    private string invoice()
    {
        ...
        {
            string invoice2 =Convert.ToInt32(dte.Rows[0]["invno"].ToString()).ToString();
            return invoice2;
