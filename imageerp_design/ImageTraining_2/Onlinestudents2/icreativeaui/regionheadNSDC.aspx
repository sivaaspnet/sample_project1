<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="regionheadNSDC.aspx.cs" Inherits="superadmin_TechnicalHead" Title="Region Head Details" %>
...
<script language="javascript" type="text/javascript">
 ...
 function Techeadvalidate()
 {
  ...
  var re = /(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}/;
    ...
    if(trim(document.getElementById("ContentPlaceHolder1_ddc_region").value)=="")
         {
             document.getElementById("ContentPlaceHolder1_ddc_region").value=="";
             document.getElementById("ContentPlaceHolder1_lblmsg1").innerHTML ='*Please Select Region..!';
    ...
    else if(trim(document.getElementById("ContentPlaceHolder1_txttech_name").value)=="")
         {
...
// ]]>
 ...
 <div class="title-cont">
    <h3 class="cont-title">Region Head Details(NSDC)</h3>
    </div>
