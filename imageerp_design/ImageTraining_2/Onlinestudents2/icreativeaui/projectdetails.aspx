<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="projectdetails.aspx.cs" Inherits="superadmin_Moduledetails" Title="Projectdetails" %>
...
document.getElementById("ContentPlaceHolder1_ddl_course").value="";
  ...
  var liste = document.getElementById("ContentPlaceHolder1_Listbox_Software");
   ...
   <h4>
    ...
    <td >
       &nbsp;
        <asp:DropDownList ID="ddlsearchcourse" runat="server" Width="350px">
        </asp:DropDownList>&nbsp;
    ...
    <asp:GridView CssClass="common" ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="No Records Found" OnRowCommand="GridView1_RowCommand" OnPageIndexChanging="GridView1_PageIndexChanging" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action">
                         <ItemTemplate>
                             ...
                             <asp:LinkButton ID="lnkdelete" runat="server" CommandName="del" CommandArgument='<%#Eval("Id")%>' OnClientClick="javascript:return confirm('Do you want to delete?');"><img src="layout/delete.png" alt="delete" /></asp:LinkButton>
                         </ItemTemplate>
        ...
        <EmptyDataRowStyle Font-Bold="True" ForeColor="Red" />
		 ...
		 <br />
		 <h4>Add/Update Project Details</h4>
