<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="marketing.aspx.cs" Inherits="superadmin_marketing" Title="Marketing Manager Details" %>
...
if(trim(document.getElementById("ContentPlaceHolder1_txtcounselor_name").value)=="")
         {
             ...
             document.getElementById("ContentPlaceHolder1_lblmsg1").innerHTML = '*Please Enter the Marketing Manager Name!';
...
<div class="search-sec-cont">
 ...
 <ul>
      <li><div class="wth-1">Searchby Marketing Manager Name</div>
...
<div style="padding:0px 10px 10px 10px">
        <asp:GridView ID="grdcounselor" runat="server" CssClass="tbl-cont3" AutoGenerateColumns="False" OnRowCommand="grdcounselor_RowCommand" AllowPaging="True" EmptyDataText="No Results Found" OnPageIndexChanging="grdcounselor_PageIndexChanging" PageSize="5" width="100%">
            <Columns>
                <asp:TemplateField HeaderText="Marketing Manager Name">
                <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Password">
                 <ItemTemplate>
                  <%#removetilde(Eval("password").ToString())%>
                 </ItemTemplate>
                </asp:TemplateField>
...
<div align="center">
       ...
       <li>
            <label class="label-txt">
             ...
             <asp:TextBox ID="txtcounselor_repwd" runat="server" MaxLength="20" TextMode="Password" CssClass="text input-txt" Width="260px"></asp:TextBox>
            </li>
          <li>
            <label class="label-txt">
                    Marketing Manager Email ID</label>
...
<asp:ListItem Value="Disable" Text="Disable"></asp:ListItem></asp:DropDownList></li>
    ...
    <input id="btnreset" type="button" value="Reset" class="btnStyle2" onclick="return btnreset_onclick()"/></div></li>
