<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="certificatelogin.aspx.cs" Inherits="superadmin_Counselordetails" Title="Certificate Details" %>
...
<div class="free-forms">
    <table class="common" width="100%">
        <tr>
            <td style=" padding:0px; height: 29px;"><h4>
                Certificate Department Details</h4>
    ...
    <br />
     ...
     <br />
        ...
        <table class="common"  width="100%" >
            <tr>
                <td  colspan="3" style="padding:0px;" > <h4>Add Details</h4>
                </td>
            </tr>
            <tr>
