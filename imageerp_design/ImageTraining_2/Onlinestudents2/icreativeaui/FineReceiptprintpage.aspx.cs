...
public partial class superadmin_FineReceiptprintpage : System.Web.UI.Page
{
    string _Qry;
    int Invoice_no = 0;
       ...
       DataTable dts = new DataTable();
        ...
        if (dts.Rows.Count > 0)
        {
           ...
           tabletemplate = tabletemplate.Replace("##Receiptdate##", dts.Rows[0]["date"].ToString());
            ...
            tabletemplate = tabletemplate.Replace("##address 1##", "");
            tabletemplate = tabletemplate.Replace("##address 2##", "");
            ...
            Label2.Text = tabletemplate.ToString();
        }
    //}
    //catch (Exception ex)
    //{
