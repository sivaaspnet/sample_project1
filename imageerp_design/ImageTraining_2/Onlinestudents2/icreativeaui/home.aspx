...
<table  class="login_table" style="width: 223px" id="TABLE1" language="javascript" onclick="return TABLE1_onclick()">
  ...
  <tr>
    <td class="userlogin" style="width: 65px;font-weight:bold;"><label for="password">
        <strong>
        <asp:TextBox ID="txtusername" runat="server" CssClass="TextBox"  ></asp:TextBox></strong></label></td>
    <td style="width: 154px" >
...
<div  id="wrapper" runat="server">
        <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
               <img src="layout/slider1.jpg" width="957"  height="350" alt="" />
                <img src="layout/slider2.jpg"  width="957" height="350"  alt="" />
                <img src="layout/slider3.jpg"  width="957" height="350"  alt="" />
                <img src="layout/slider4.jpg"  width="957" height="350"  alt="" />
           </div>
       </div>
