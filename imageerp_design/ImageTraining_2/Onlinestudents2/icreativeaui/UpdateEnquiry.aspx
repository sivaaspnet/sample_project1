<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="UpdateEnquiry.aspx.cs" Inherits="UpdateEnquiry" Title="Update Enquiry" %>
    ...
    <div class="white-cont">
      <div id="tabs-1">
        <div class="free-forms">
          ...
          <div  style="text-align:center">  <asp:Label
                ID="lblmsg1" runat="server" CssClass="error"></asp:Label></div> 
          ...
          <div class="padd-cont form-cont2">
            ...
            <ul>
              <li>
                ...
                <asp:TextBox ID="txtfname" MaxLength="30" runat="server" CssClass="text input-txt" Width="300px" onkeypress="return AllowAlphabet(event)"></asp:TextBox>
              </li>
              <li>
