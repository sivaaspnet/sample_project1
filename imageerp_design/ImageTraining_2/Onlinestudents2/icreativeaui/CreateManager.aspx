<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="CreateManager.aspx.cs" Inherits="superadmin_CreateManager" Title="Create Manager" %>

<asp:Content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="Server">
      <script type="text/javascript">
$(document).ready(function(){
	$(".add-txt").click(function(event) {
...
<div class="title-cont">
 <h3 class="cont-title">Centre Manager Details</h3>
</div>
<div class="white-cont">
  ...
  <div style="text-align:center">
    ...
    <asp:GridView ID="grdcentre" runat="server" CssClass="tbl-cont3" AutoGenerateColumns="False" OnRowCommand="grdcentre_RowCommand" AllowPaging="True" OnPageIndexChanging="grdcentre_PageIndexChanging" PageSize="10" EmptyDataText="No Records Found" width="100%" OnRowDataBound="grdcentre_RowDataBound">
        <Columns>
...
<asp:ListItem Value="Disable" Text="Disable"></asp:ListItem></asp:DropDownList>                              
                      </li>
