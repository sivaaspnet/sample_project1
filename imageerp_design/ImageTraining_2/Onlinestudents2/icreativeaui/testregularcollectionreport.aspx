<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="testregularcollectionreport.aspx.cs" Inherits="superadmin_testregularcollectionreport" Title="RegularCollection Report" %>
            ...
            <Columns>
                <asp:TemplateField HeaderText="ID">
                 ...
                 <asp:TemplateField HeaderText="Invoice">
                  <ItemTemplate>
                    <a class="error" target="_blank" href='InvoiceDetails.aspx?invno=<%#Eval("invoice")%>'>
                   <%#Eval("invoice")%>
                   </a>
                 </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Tax">
                 ...
                 <asp:TemplateField HeaderText="Tot Balance Amt">
                    <ItemTemplate>
                        <%#Eval("totalbalance")%>
                    </ItemTemplate>
                </asp:TemplateField>
