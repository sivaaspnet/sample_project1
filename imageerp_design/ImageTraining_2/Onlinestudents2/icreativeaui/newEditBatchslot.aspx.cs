...
onlinestudentsfacultydetails fac on fac.faculty_id=sce.facultyid 
 where  bat.centrecode='" + Session["SA_centre_code"].ToString() + "' and year(sce.classdate)='" + ddlyear.SelectedValue + "' ";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if ((count == 6 && ddlslot.SelectedValue == "Daily") || (count == 3 && ddlslot.SelectedValue == "MWF") || (count == 3 && ddlslot.SelectedValue == "TTS") || (count == 12 && ddlslot.SelectedValue == "ZIP") || (count == 4 && ddlslot.SelectedValue == "WEEKEND"))
        {
    ...
    protected void btnconform_Click(object sender, EventArgs e)
    {
        ...
        else if (ddlslot.SelectedValue == "ZIP")
        {
            slotdate = "0,2,3,4,5,6,7";
        }
        else if (ddlslot.SelectedValue == "WEEKEND")
        {
            slotdate = "6,7";
        }
        else if (ddlslot.SelectedValue == "custom")
        {
        ...
        if (ddlslot.SelectedValue != "ZIP" || ddlslot.SelectedValue != "WEEKEND")
        {
