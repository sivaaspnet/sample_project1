<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="ParallelBatch.aspx.cs" Inherits="Onlinestudents2_superadmin_ParallelBatch" Title="Parallel Batch" %>
...
<tr>
    ...
    <table class="common">
        ...
        <tr>
            <td colspan="2"  style=" text-align:center;">
                <br />
                <asp:Button ID="btn_Movestudent" runat="server" CssClass="submit" OnClientClick="javascript:return changebatch();" Text="Allocate>>" OnClick="btn_Movestudent_Click1"/><br />
            </td>
        </tr></table>
            <br />
        </td>
