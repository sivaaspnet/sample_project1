<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Invoiceprint.aspx.cs" Inherits="Onlinestudents2_superadmin_Invoiceprint" %>
        ...
        <asp:Label ID="lbladdress" runat="server" Text=''></asp:Label></td>
          ...
          <tr>
             <td>
              ...
              <td>
                  Tax 
                  <asp:Label ID="lbl_taxpercentage" runat="server"></asp:Label></td>
              <td>
                  <asp:Label ID="lbltax" runat="server"></asp:Label></td>
          </tr>
          ...
          <tr>
            <td colspan="8" valign="top"><table width="807" border="0"  cellspacing="0" >
                  ...
                  <table width="811" border="0"cellpadding="0">
                      <tr>
                        ...
                        <td><table border="0" cellspacing="0">
                            <tr>
                              <td>
                                  <strong>For</strong> <strong>
                                      <asp:Label ID="lbl_img" runat="server" Font-Bold="False" Text="Image Creative Education Pvt. Ltd."></asp:Label><asp:Label
                                          ID="lbl_ganga" runat="server" Font-Bold="False" Text="VNxTL Tech Services Pvt. Ltd. "
                ...
                <table width="800">
                    ...
                    <tr>
                        <td align="left">
                            <span style="font-size: 9pt">3.Cheque/DD should be drawn in facour of <strong>Image Creative Education Pvt. Ltd.</strong>.,</span></td>
                    </tr>
                    <tr>
                        <td align="left">
                            ...
                            &nbsp;<span style="font-size: 10pt"><strong>Franchisor: Image Creative Education Pvt. Ltd.,<br />
                                &nbsp; </strong><span style="font-size: 9pt"><span style="font-family: Arial"> Head Office:32,
                                    ...
                                    &nbsp; </span></span><span style="font-size: 9pt; font-family: 'Arial','sans-serif'">
                                        Service Tax Regn.No:<span id="Label1"><span style="font-size: 9pt; font-family: 'Arial','sans-serif'">AAACI6238BST001</span></span></span></span></td>
                    </tr>
