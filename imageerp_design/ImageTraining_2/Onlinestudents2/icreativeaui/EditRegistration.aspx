<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="EditRegistration.aspx.cs" Inherits="EditRegistration" Title="Edit Registration" %>
...
{ 
    ...
    else if(document.getElementById("ContentPlaceHolder1_hdncentrecode").value=='tvm-1' || document.getElementById("ContentPlaceHolder1_hdncentrecode").value=='ICH-101' || document.getElementById("ContentPlaceHolder1_hdncentrecode").value=='ICH-102' ||document.getElementById("ContentPlaceHolder1_hdncentrecode").value=='ICH-103' ||document.getElementById("ContentPlaceHolder1_hdncentrecode").value=='ICH-106' || document.getElementById("ContentPlaceHolder1_hdncentrecode").value=='IBG-101' || document.getElementById("ContentPlaceHolder1_hdncentrecode").value=='ICA-101' )
    {
        if(document.getElementById("ContentPlaceHolder1_hdncoursetype").value=='Certificate')
        {
...
function Reset1_onclick() {
            ...
            <TR class="no-borders">
              ...
              <td align="left"><asp:HiddenField id="HiddenField2" runat="server" Value="0"></asp:HiddenField>
                <asp:Button id="Btnupdate" onclick="Btnupdate_Click" runat="server" Text="Update Receipt" CssClass="btnStyle1" OnClientClick="javascript:return add();"></asp:Button>
              </TD>
            </TR>
          </TBODY>
        </TABLE>
        ...
        <div class="dataGrid">
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <asp:TemplateField HeaderText="Click To Enroll">
              ...
              <ItemTemplate>   <asp:LinkButton ID="lnkedit" runat="server" CommandName="edt" ToolTip="Edit" CommandArgument='<%#Eval("id")%>'   >Edit</asp:LinkButton></ItemTemplate>
            </asp:TemplateField>
            </Columns>
          </asp:GridView>
          ...
          <input id="hdninitamt" runat="server" type="hidden" />
            <input id="hdnReceiptID" runat="server" type="hidden" />
               <input id="hdnReceiptNum" runat="server" type="hidden" />
        </div>
      </div>
    </div>
  </div>
