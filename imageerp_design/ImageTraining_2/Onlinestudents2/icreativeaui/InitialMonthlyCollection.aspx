<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="InitialMonthlyCollection.aspx.cs" Inherits="superadmin_InitialMonthlyCollection" Title="Initial Monthly Collection Report" %>
...
function validview()
{
    ...
    <table cellpadding="1" class="common" runat="server" visible="false">
        <tr>
    ...
    <tr><td style="padding:0px;">
      <h4>
          Collection Report (Initial Only)  
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp; &nbsp;
          <asp:LinkButton ID="lnkmonthly"  runat="server" OnClick="lnkmonthly_Click">View Full Collection</asp:LinkButton></h4></td></tr>
      <tr><td>
    <p>
        <table border="0" cellpadding="0" width="100%">
         <tr visible="false" runat="server">
            ...
            <td colspan="3">
                From Date &nbsp; &nbsp;&nbsp;
                <asp:TextBox ID="TextBox1"  runat="server"  onpaste="return false" onKeyPress="return false"  CssClass="text datepicker" Width="92px"></asp:TextBox>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; To Date &nbsp; &nbsp;
                <asp:TextBox ID="TextBox2"  runat="server" onpaste="return false" onKeyPress="return false"  CssClass="text datepicker" Width="92px"></asp:TextBox>&nbsp;
            ...
            <tr  runat="server">
                ...
                <td align="left" style="width: 40%; height: 19px" valign="middle">
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Total
                    Collection Amount :
       ...
       <asp:GridView ID="Gridview_admission" runat="server" CssClass="common"  AutoGenerateColumns="False" OnPageIndexChanging="Gridview_admission_PageIndexChanging" EmptyDataText="No records Found" Width="100%" >
        ...
        &nbsp;</p>
          <p>
              &nbsp;<asp:LinkButton ID="downloadlink" runat="server" OnClick="downloadlink_Click">Download Excel</asp:LinkButton></p>
      </td></tr>
        </table>
