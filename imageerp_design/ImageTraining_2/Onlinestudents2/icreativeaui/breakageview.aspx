<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" EnableEventValidation="false"  AutoEventWireup="true" CodeFile="breakageview.aspx.cs" Inherits="Onlinestudents2_Default" Title="BreakageFees" %>
...
$(document).ready(function() {
  ...
  <div class="title-cont">
    <h3 class="cont-title">View Breakage Details</h3>
    <div class="breadcrumps">
      <ul>
        
        <li><a href="breakage.aspx">Breakage Details</a>/</li>
        <li><a href="#" class="last">View Breakage Details</a></li>
      </ul>
    </div>
    <div class="clear"></div>
  </div>
  ...
  <div class="white-cont" style="padding:10px;">
   <div style="padding:0px 10px 10px 10px">
      <asp:GridView ID="GridView1" runat="server" CssClass="tbl-cont3" AutoGenerateColumns="False" EmptyDataText="No Records" Width="100%" AllowPaging="True" onpageindexchanging="GridView1_PageIndexChanging">
        <Columns>
        <asp:BoundField DataField="studentId" HeaderText="Student Id" />
        <asp:BoundField DataField="enq_personal_name" HeaderText="Student Name" />
        <asp:BoundField   DataField="totalAmount" HeaderText="Breakage Fees" />
        <asp:BoundField DataField="remarks" HeaderText="Reason" />
        <asp:TemplateField HeaderText="Receipt_no">
          <ItemTemplate> <a rel="modal[]" href="receiptprint.aspx?studId=<%#Eval("studentId")%>&recptno=<%#Eval("receiptNo")%>&invoiceno=<%#Eval("invoiceNo")%>&iframe=true&amp;width=100%&amp;height=100%"><%#Eval("receiptNo")%></a> </ItemTemplate>
        </asp:TemplateField>
        </Columns>
      </asp:GridView>
