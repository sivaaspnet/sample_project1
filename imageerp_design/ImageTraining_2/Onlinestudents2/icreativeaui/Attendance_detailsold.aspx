<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="Attendance_detailsold.aspx.cs" Inherits="Onlinestudents2_Attendance_detailsold" Title="Attendance Details" %>
    ...
    <table id="tblatt" visible="false" runat="server" class="common" width="100%" >
          ...
          <td>
                   ...
                   <tr runat="server" visible="false" id="reasonconducted">
                       ...
                       <td style="height: 35px">
                           <asp:TextBox ID="txtreasonnotpost" runat="server" CssClass="text" Height="18px" MaxLength="200"
                               ReadOnly="false" Width="330px"></asp:TextBox>&nbsp;
                           <asp:Button ID="btnnotpost" runat="server" CssClass="submit"  OnClientClick="javascript:return conduct();" OnClick="btnnotpost_Click"
                               Text="Add" /></td>
                   </tr>
        <tr id="reasonvis" runat="server" visible="false">
            ...
            <td style="height: 35px">
                ...
                <asp:Button ID="btncan" runat="server" CssClass="submit"  OnClientClick="javascript:return cancel();" OnClick="btncan_Click" Text="Add" /></td>
        </tr>
                <tr>
