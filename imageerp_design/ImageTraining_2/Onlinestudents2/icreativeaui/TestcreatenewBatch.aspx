<%@ Page Language="C#" MasterPageFile="1imagemasterpage.master" AutoEventWireup="true" CodeFile="TestcreatenewBatch.aspx.cs" Inherits="superadmin_TestcreatenewBatch" Title="Create New Batch" %>
...
function changepayment()
 ...
 if(document.getElementById("ContentPlaceHolder1_DropDownList1").value=="6,7" || document.getElementById("ContentPlaceHolder1_DropDownList1").value=="0,6,7")
 {
 ...
 if(document.getElementById("ContentPlaceHolder1_DropDownList1").value=="0")
 {
         ...
         <table class="common" id="getdetails"  runat="server" width="100%">
             ...
             <tr>
                 ...
                 <td style="">
                         ...
                         <asp:ListItem Value="0,6,7">WEEKEND 2Hr</asp:ListItem> 
                     </asp:DropDownList>
                    ...
                    <asp:CheckBoxList ID="CheckBoxList3" runat="server" RepeatDirection="Horizontal"  visible="false">
