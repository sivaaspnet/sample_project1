<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="leavereport.aspx.cs" Inherits="superadmin_Droppedstudentdetails" Title="Leave Details" %>
    ...
    <tr><td>
        ...
        <tr>
            <td >
               ...
               From Date<br />
                &nbsp;
                <asp:TextBox ID="txtfromcalender" runat="server" CssClass="text datepicker" onkeypress="return false" onkeydown="return false" onpaste="return false" ></asp:TextBox>
...
<div class="free-forms">
 ...
 <h4>Student Leave Details</h4></td></tr>
    <tr>
        <td>
        
            Student ID/Name :
            <asp:TextBox ID="TextBox2" runat="server" CssClass="text" MaxLength="50"></asp:TextBox>&nbsp;<asp:Button
                ID="Button1" runat="server" OnClientClick="javascript:return val();" CssClass="search" OnClick="Button1_Click" />
                <br />
 ...
 <tr><td>
	...
	<div class="dataGrid">
        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            CssClass="common" EmptyDataText="No Leave Request" OnPageIndexChanging="grdcentre_PageIndexChanging"
            ...
            <Columns>
               <asp:TemplateField HeaderText="Student ID">
                   ...
                   <ItemTemplate>
                    <a class="error" href='studentreportdetails.aspx?StudentID=<%#Eval("studentid")%>#report3'>
                        <%#Eval("studentid")%>
                    </a>
                </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Technical Head">
                    <ItemTemplate>
                        ...
                        &nbsp; &nbsp;<asp:LinkButton ID="lnkdecline" runat="server" CommandArgument='<%#Eval("id")%>'
                            CommandName="decline">Decline</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="CentreManager">
                    <ItemTemplate>
                        <asp:Label ID="lblstatus1" runat="server" Text='<%#Eval("status_cen")%>'></asp:Label>
                        <asp:LinkButton ID="lnkapprove1" runat="server" CommandArgument='<%#Eval("id")%>'
                            CommandName="approve1">Approve</asp:LinkButton>
                        &nbsp; &nbsp;<asp:LinkButton ID="lnkdecline1" runat="server" CommandArgument='<%#Eval("id")%>'
                            CommandName="decline1">Decline</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
