...
public partial class superadmin_createnewBatch : System.Web.UI.Page
{
    ...
    private void fillgrid()
    {
        try
        {
            ...
            _Qry = "select * from [shufflestudent] ('" + Session["SA_centre_code"] + "','" + ddl_coursename.SelectedValue + "','" + chk + " ')";
                    ...
                    else
                    {
                        _Qry = "select subcontent_id,classdate,software_id from erp_batchcontentstatus where batchcode='"+ddl_batchcode2.SelectedValue+"'";
                         ...
                         for (int i = 0; i < dt.Rows.Count; i++)
                         {
                              ...
                              _Qry = @"update INTO [erp_batchschedule] set [studentId]='" + stdid + "',[facultyId]='" + fac_id.Text + "',[labId]='" + lab_id.Text + "',[classDate]='" + clsdate + "',[batchCode]='" + ddl_batchcode2.SelectedValue + "',[batchTiming]='" + lbl_timing.Text + "' ,[subContentId]=" + subcontentid + " ,[Software_Id]='" + softid + "' where centrecode='" + Session["SA_centre_code"].ToString() + "'  and status='Pending' and batchstatus='deactive' and [subContentId]=" + subcontentid + " and [Software_Id]='" + softid + "'";
