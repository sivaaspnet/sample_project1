...
if(found == true)$(row).show();else $(row).hide();
	...
	<table width="100%" class="studReport">
		<tr id="tr1" runat="server">
        <td align="left" valign="middle" style="width: 255px; height: 7px;">
        ...
        <td align="left" valign="middle" style="height: 7px; width: 209px;">
            ...
            <td align="left" colspan="4" rowspan="9" valign="middle" style="color: #000000; width: 8px;">
            ...
            <tr id="Tr7" runat="server">
                <td align="left" style="width: 255px; height: 10px" valign="middle">
        ...
        <tr runat="server" id="Tr2">
            <td align="left" style="height: 20px; width: 255px;" valign="middle">
        ...
        <tr runat="server" id="Tr3">
            <td align="left" style="height: 18px; width: 255px;" valign="middle">
        ...
        <tr runat="server" style="color: #000000" id="Tr14">
            <td align="left" style="width: 176px; height: 25px" valign="middle">
                <asp:Label ID="Label19" runat="server" Font-Bold="True" Text="Enrollment Date :"></asp:Label></td>
            <td align="left" style="width: 148px; height: 25px" valign="middle">
      ...
      <table width="100%" class="studReport">
        ...
        <table style="WIDTH: 417px; height: 146px; left: 0px; top: 0px;" class="studReport">
        <tr>
            <td style="width: 176px; height: 25px">
	...
	<table class="common">
            ...
            <tr>
                        <td style="">
                            <asp:Label ID="Label25" runat="server" Font-Bold="True" ForeColor="Maroon" Text="Find By : Software"></asp:Label>
                            <asp:TextBox
        ...
        <asp:GridView  ID="GridView1"  runat="server" AutoGenerateColumns="False" PageSize="25" CssClass="common" EmptyDataText="No Record Found">
            <Columns>
                ...
                <ItemTemplate>
                <a rel="modal" href="studentmodulebatch.aspx?studentid=<%#Eval("studentid")%>&moduleid=<%#Eval("moduleid")%>&softwareid=<%#Eval("software_id")%>&iframe=true&amp;width=500&amp;height=300" class="error"><%#Eval("software")%></a>
