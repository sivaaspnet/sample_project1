...
public partial class superadmin_TestcreatenewBatch : System.Web.UI.Page
{
   ...
   // Response.Write(_Qry);
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
     {        
         ...
         if (CheckBoxList3.Visible == true && DropDownList1.SelectedItem.Text == "Custom")
         {
         ...
         if (DropDownList1.SelectedItem.Text == "WEEKEND" || DropDownList1.SelectedItem.Text == "WEEKEND 2Hr" || DropDownList1.SelectedItem.Text == "Custom")
         {
             slotdate = values;
         }       
         else
         {
             slotdate = DropDownList1.SelectedValue;
             
         }

         if (DropDownList1.SelectedItem.Text == "ZIP" || DropDownList1.SelectedItem.Text == "WEEKEND")
         {
...
sce.batchtiming in ('" + ddlbatch.SelectedValue.ToString() + "','" + ddlbatch0.SelectedValue.ToString() + "')  and   facultyid='" + ddlfac.SelectedValue + "' and   sce.centrecode='" + Session["SA_centre_code"].ToString() + "' and convert(varchar(10),dateadd(d,0,sce.classdate),101)  in (" + classdate + ") and sts.status='Pending' and sce.batchstatus='active'";
        ////Response.Write(_Qry+"<br>");
         ...
         else
         {
             ...
             if(Convert.ToInt32(hdnfreesystem.Value)>0)
             {
                 ...
                 if (DropDownList1.SelectedItem.Text != "ZIP" || DropDownList1.SelectedItem.Text != "WEEKEND")
                 {
                     batchqry += " INSERT INTO [erp_batchdetails] ([software_id],[batchCode],[moduleId],[NoOfClass],[centreCode],[slot],[batchTiming],[status],[dateins],[slotday]) VALUES ('" + os + "','" + batch_code + "','" + ddl_coursename.SelectedValue + "','" + noofclass + "','" + Session["SA_centre_code"].ToString() + "','" + DropDownList1.SelectedItem.Text + "','" + ddlbatch.SelectedValue + "','pending',getdate(),'" + slotdate + "') ";

                 }
                 else
                 {
                     batchqry += " INSERT INTO [erp_batchdetails] ([software_id],[batchCode],[moduleId],[NoOfClass],[centreCode],[slot],[batchTiming],[status],[dateins],[slotday]) VALUES ('" + os + "','" + batch_code + "','" + ddl_coursename.SelectedValue + "','" + noofclass + "','" + Session["SA_centre_code"].ToString() + "','" + DropDownList1.SelectedItem.Text + "','" + ddlbatch.SelectedValue + "," + ddlbatch0.SelectedValue + "','pending',getdate(),'" + slotdate + "') ";
                ...
                lblslot.Text = DropDownList1.SelectedItem.Text;
    ...
    private void fillfree()
    {
        ...
        sdatetest = splittest[2] + "-" + splittest[1] + "-" + splittest[0];
            ...
            if(DropDownList1.SelectedItem.Text=="MWF")
               {
                   valuesmwf = "2,4,6";
                }
            if (DropDownList1.SelectedItem.Text == "TTS")
            {
                valuestts = "3,5,7";
            }
            if (DropDownList1.SelectedItem.Text == "DAILY")
            {
                valuesmwf = "2,4,6";
                valuestts = "3,5,7";
            }
            if (DropDownList1.SelectedItem.Text == "ZIP")
            {
                valuesmwf = "2,4,6";
                valuestts = "3,5,7";
            }
            if (DropDownList1.SelectedItem.Text == "WEEKEND")
            {
                valuesmwf = "6";
                valuestts = "7";
            }
            if (DropDownList1.SelectedItem.Text == "WEEKEND 2Hr")
            {
                valuesmwf = "6";
                valuestts = "7";
            }
        ...
        if (countmod > 0)
        {
          ...
          // Response.End();
            ...
            else
            {
                ...
                if (DropDownList1.SelectedItem.Text == "Custom")
                {
            ...
            ////    Response.End();
                int count = 0;            
                count = MVC.DataAccess.ExecuteScalar(MVC.DataAccess.ConnectionString, _Qry);
                if ((DropDownList1.SelectedItem.Text == "Custom") || (count == 6 && DropDownList1.SelectedItem.Text == "Daily") || (count == 3 && DropDownList1.SelectedItem.Text == "MWF") || (count == 3 && DropDownList1.SelectedItem.Text == "TTS") || (count == 12 && DropDownList1.SelectedItem.Text == "ZIP") || (count == 4 && DropDownList1.SelectedItem.Text == "WEEKEND") || (count == 2 && DropDownList1.SelectedItem.Text == "WEEKEND") || (count == 2 && DropDownList1.SelectedItem.Text == "WEEKEND 2Hr"))
                {
                    if (DropDownList1.SelectedItem.Text == "Custom")
                    {
    ...
    protected void ddl_coursename_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddl_coursename.SelectedIndex > 0)
        {
            ...
            DropDownList1.Items.Remove(new ListItem("Custom", "0"));
            if ((ddl_coursename.SelectedItem.Text.ToLower().Contains("bsc")) || (ddl_coursename.SelectedItem.Text.ToLower().Contains("b.sc")))
            {
                ...
                DropDownList1.Items.Add(new ListItem("Custom","0"));
