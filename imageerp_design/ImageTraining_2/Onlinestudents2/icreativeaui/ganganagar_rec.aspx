<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ganganagar_rec.aspx.cs" Inherits="superadmin_Receiptprint" %>
        ...
        <table width="600"  border="0">
          <tr>
            ...
            <td style="width: 419px"><table align="CENTER" id="TABLE1" style="width: 458px">
              <tr>
                <td class="style3 style5" style="height: 38px; width: 454px;"><div align="center" class="style5 style1"><strong> <span style="font-size: 24pt">&nbsp;&nbsp; &nbsp; Image Infotainment Limited</span></strong></div></td>
              </tr>
              <tr>
                <td class="style3" style="width: 454px"><div align="center">Regd. Office : 32,T.T.K Road,Alwarpet,Chennai-600018.</div></td>
              </tr>
              <tr>
                <td class="style3" style="width: 454px"><div align="center">Phone:044-24661682/24670229 Fax:044-42737755 </div></td>
              </tr>
            </table></td>
          </tr>
        </table>
          ...
          <table>
            ...
            <td align="center" valign="middle">
                    <input id="Button1" class="submit" onclick="window.open('Receiptprintpage.aspx?studid=<%=lblstudid.Text%>&recptno=<%=lbl_recpno.Text%>','PrintMe','height=500px,width=600px,scrollbars=1')"
