<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="Bookdetails.aspx.cs" Inherits="superadmin_Moduledetails" Title="Bookdetails" %>
...
<h4>
    ...
    <table cellpadding="0" cellspacing="0" class="common" width="100%">
        <tr>
            <td style="padding:0px;" >
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                <asp:Label ID="lblsearchsoftware" runat="server" Text="Searchby Book Name"></asp:Label></td>
        </tr>
        <tr>
    <td style="padding-bottom:0px;" >
       &nbsp;
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<asp:TextBox ID="txtsoftsearch" runat="server" CssClass="text"></asp:TextBox>
        &nbsp;
    ...
    <asp:GridView CssClass="common" ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="No Records Found" OnRowCommand="GridView1_RowCommand" OnPageIndexChanging="GridView1_PageIndexChanging" Width="100%">
                <Columns>
                    ...
                    <asp:BoundField DataField="book_content" HeaderText="Book Name" />
                   
                                   
                    <asp:TemplateField HeaderText="Action">
                         <ItemTemplate>
                             <asp:LinkButton ID="lnkedit" runat="server" CommandName="edt" CommandArgument='<%#Eval("CourseBook_Id")%>'><img src="layout/edit.png" alt="edit" /></asp:LinkButton> |
                             <asp:LinkButton ID="lnkdelete" runat="server" CommandName="del" CommandArgument='<%#Eval("CourseBook_Id")%>' OnClientClick="javascript:return confirm('Do you want to delete?');"><img src="layout/delete.png" alt="delete" /></asp:LinkButton>
                         </ItemTemplate>
    ...
    <asp:Label ID="lblmsg1" CssClass="error" runat="server" Text=""></asp:Label></td>
                ...
                <tr>
                    <td class="formlabel">
                        Book</td>
                    <td>
                        <asp:ListBox ID="Listbox_Software" runat="server" Height="82px" SelectionMode="Multiple" >
                        </asp:ListBox>
                    </td>
                </tr>
        <tr>
