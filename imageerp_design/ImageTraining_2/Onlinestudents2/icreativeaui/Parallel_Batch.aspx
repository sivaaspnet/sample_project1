<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="Parallel_Batch.aspx.cs" Inherits="OnlineStudents_superadmin_Parallel_Batch" Title="Parallel Batch" %>
    ...
    <table class="common">
        ...
        <tr>
            <td colspan="2" style="text-align:center;">
                <asp:Button ID="btn_Movestudent" runat="server" CssClass="submit" OnClientClick="javascript:return changebatch();" Text="Allocate>>" OnClick="btn_Movestudent_Click1"/>
...
<td style="vertical-align:top;">
     <table class="common">
        ...
        <tr><td style="width: 97px">
            Studentid</td><td>
                <asp:GridView ID="grdB2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    CssClass="common" EmptyDataText="No Student Records Found">
                    <EmptyDataRowStyle Font-Bold="True" ForeColor="Red" />
                    <Columns>
                        <asp:TemplateField HeaderText="Student Id">
