<%@ Page Language="C#" MasterPageFile="imagemasterpage.master" AutoEventWireup="true" CodeFile="Breakagereceipt.aspx.cs" Inherits="superadmin_Receiptedit" Title="Receipt Edit Page" %>
    ...
    function CheckNumeric(GetEvt)
{
 ...
 function add()
 {    
if(trim(document.getElementById("ContentPlaceHolder1_txt_Invoiceno").innerHTML)=="")
         {    
             alert("Please enter invoice no");
             document.getElementById("ContentPlaceHolder1_txt_Invoiceno").innerHTML = "";
             document.getElementById("ContentPlaceHolder1_txt_Invoiceno").focus();
             document.getElementById("ContentPlaceHolder1_txt_Invoiceno").style.border="#ff0000 1px solid";
             document.getElementById("ContentPlaceHolder1_txt_Invoiceno").style.backgroundColor="#e8ebd9";
             return false;
         }
         else if(trim(document.getElementById("ContentPlaceHolder1_txt_coursecode").innerHTML)=="")
         {    
             alert("Please select Course code");
             document.getElementById("ContentPlaceHolder1_txt_coursecode").innerHTML = "";
         ...
         else if (document.getElementById("ContentPlaceHolder1_ddlpaymenttowards").value == "") {
             alert("Please select Payment Reason");
             document.getElementById("ContentPlaceHolder1_ddlpaymenttowards").value = "";
             document.getElementById("ContentPlaceHolder1_ddlpaymenttowards").focus();
             document.getElementById("ContentPlaceHolder1_ddlpaymenttowards").style.border = "#ff0000 1px solid";
             document.getElementById("ContentPlaceHolder1_ddlpaymenttowards").style.backgroundColor = "#e8ebd9";
             return false;
         }
...
function test_skill(rup) {
	...
	//document.getElementById('ContentPlaceHolder1_Label1').innerHTML=finalWord;
	document.getElementById('ContentPlaceHolder1_hdnpayinword').value=finalWord;
	//alert(document.getElementById('ContentPlaceHolder1_hdnpayinword').value);
        ...
        <ul>
          <li>
            <label class="label-txt">
                  ...
                  <asp:Label ID="txt_Invoiceno" runat="server" CssClass="label-txt2"
                            onkeypress="return CheckNumeric(event)"></asp:Label></li>
                        
              <li>
            <label class="label-txt">
                        Course Code</label>
                 <asp:Label ID="txt_coursecode" CssClass="label-txt2" runat="server" Text=""></asp:Label></li>
              <li>
            <label class="label-txt">
                Student Name</label>
           <asp:TextBox ID="txt_studname" runat="server" CssClass="text input-txt" MaxLength="50"></asp:TextBox></li>
      <li>
            <label class="label-txt">
                Breakage</label>
             <asp:DropDownList onChange="calctax(this)" Visible="false" ID="ddl_breakage" runat="server" CssClass="sele-txt"> 
               </asp:DropDownList>
       ...
       <li>
            <label class="label-txt">
                Payment In Words</label>
                <asp:Label ID="txt_paymentwords" runat="server" Text='' CssClass="label-txt2"></asp:Label>&nbsp;<br />
...
function Reset1_onclick() {
         ...
         <li>
            <label class="label-txt">
                Payment Reason</label>
                 <asp:DropDownList runat="server" ID="ddlpaymenttowards" CssClass="sele-txt">
               <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                <asp:ListItem Text="Breakage" Value="Breakage"></asp:ListItem>
                 <asp:ListItem Text="Fine" Value="Fine"></asp:ListItem>
                  <asp:ListItem Text="Miscellaneous" Value="Miscellaneous"></asp:ListItem></asp:DropDownList></li>
            <li>
            <label class="label-txt">
       ...
       <li>
            <label class="label-txt">
                Reason</label>
           <asp:TextBox ID="txtreason" runat="server" TextMode="MultiLine" CssClass="text input-txt" Width="260px"></asp:TextBox></li>
        <li>
            <label class="label-txt">
                Payment Mode</label>
      ...
      <asp:TextBox ID="txt_ddcc" onKeyPress="return CheckNumeric(event)" onFocus="losefocus(this)" CssClass="text input-txt" MaxLength="10" runat="server"></asp:TextBox></li>
      <li>
            <label class="label-txt">
                Cheque / D.D Date</label>
                <span class="date-pick-cont">
                <asp:TextBox ID="txt_dddate" runat="server" CssClass="text datepicker date-input-txt" onpaste="return false" onkeypress="return false" Width="121px"></asp:TextBox>
        </span></li>
        <li>
            <label class="label-txt">
                Bank Name</label>
      <asp:TextBox ID="txt_bankname" onFocus="losefocus(this)" runat="server" CssClass="text input-txt" MaxLength="30"></asp:TextBox></li>
        <li>
            <label class="label-txt">
                Payment Towards</label>
           <asp:Label ID="txt_paymenttowards" runat="server" Text=' Image Creative Education Pvt Ltd.' CssClass="label-txt2"></asp:Label></li>
         <li>
            <div align="center">
